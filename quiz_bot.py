...
TOPICS = {
    ...
    "pul_yakuniy": {
        "cat": "pul",
        "uz" : "412ta lik yakuniy test",
        "ru" : "Итоговый тест 412 вопросов",
        "questions": [
            {"q":"Islom imperiyasida Abdumalik 696-yilda pul islohotidan so'ng qaysi turdagi tangalardan foydalanilgan?","opts":["Arab (islom) tangalari – dinar va dirham", "Rim tangalari", "Vizantiya tangalari", "Xitoy tangalari"],"ans":0,"exp":"To'g'ri javob: C) Arab (islom) tangalari – dinar va dirham"},
            {"q":"Natural shakldagi pullarga qaysilar kiradi?","opts":["Dinar, dirham, rubl", "Qog'oz pul, plastik karta, obligatsiya", "Veksel, chek, bitkoin", "Qo'y, buqa, tuz, bug'doy, guruch, buqa terisi"],"ans":3,"exp":"To'g'ri javob: B) Qo'y, buqa, tuz, bug'doy, guruch, buqa terisi"},
            {"q":"Kredit pullarga qaysilar kiradi?","opts":["Qog'oz pul, mis tanga, temir tanga", "Bitkoin, aksiya, obligatsiya", "Oltin tanga, kumush tanga", "Veksel, bank aksepti, chek, banknot, kredit plastik karta"],"ans":3,"exp":"To'g'ri javob: B) Veksel, bank aksepti, chek, banknot, kredit plastik karta"},
            {"q":"'Kripto' so'zining lug'aviy ma'nosi nima?","opts":["Yashirin, maxfiy (yunoncha: kryptos)", "Raqamli", "Elektron", "Virtual"],"ans":0,"exp":"To'g'ri javob: B) Yashirin, maxfiy (yunoncha: kryptos)"},
            {"q":"Nima uchun dastlab banklarga qog'oz pul chiqarish ruxsat berilgan, keyinchalik bu bekor qilingan?","opts":["Xalq qog'oz pulni qabul qilmagani uchun", "Dastlab qog'oz pul oltin bilan ta'minlangan, keyinchalik banklar haddan ziyod pul chiqarib, ta'mi...", "Qog'oz pul qimmat tushgani uchun", "Davlat monopoliyasi o'rnatilgani uchun"],"ans":1,"exp":"To'g'ri javob: B) Dastlab qog'oz pul oltin bilan ta'minlangan, keyinchalik banklar haddan ziyod pul chiqarib, ta'minot buzilgan"},
            {"q":"Natural shakldagi pullarning guruhlari to'g'ri keltirilgan qator qaysi?","opts":["Hayvon va o'simlik pullari, metallmas pullar", "Naqd pullar, naqdsiz pullar", "Qimmatli qog'ozlar va depozitlar", "Tovar pullar, sigortaviy pullar, kredit pullar"],"ans":0,"exp":"To'g'ri javob: A) Hayvon va o'simlik pullari, metallmas pullar"},
            {"q":"Quyidagilarning qaysi biri haqiqiy pul?","opts":["Oltin tanga", "Kredit karta", "Chek", "Veksel"],"ans":0,"exp":"To'g'ri javob: C) Oltin tanga"},
            {"q":"Quyidagi omillardan qaysi biri tovar narxini pasaytiradi?","opts":["Talebning oshishi", "Soliqlarning oshishi", "Taklifning oshishi (ishlab chiqarish ko'payishi)", "Ishlab chiqarish xarajatlarining oshishi"],"ans":2,"exp":"To'g'ri javob: C) Taklifning oshishi (ishlab chiqarish ko'payishi)"},
            {"q":"Barter nima?","opts":["Tovarlarni to'g'ridan-to'g'ri boshqa tovarga ayirboshlash", "Pulni bankda saqlash shakli", "Kreditga tovar sotib olish", "Tovarlarni pul vositasida ayirboshlash"],"ans":0,"exp":"To'g'ri javob: B) Tovarlarni to'g'ridan-to'g'ri boshqa tovarga ayirboshlash"},
            {"q":"Pulning muomala vositasi deganda nima tushuniladi?","opts":["Pulning jamg'arish vazifasi", "Pulning hisob birligi vazifasi", "Pulning tovar va xizmatlar ayirboshlashda vositachi rolini o'ynashi", "Pulning to'lov vositasi vazifasi"],"ans":2,"exp":"To'g'ri javob: B) Pulning tovar va xizmatlar ayirboshlashda vositachi rolini o'ynashi"},
            {"q":"Bank kredit marjasi qaysi omil ta'sirida bo'lmaydi?","opts":["Ob-havo sharoiti", "Raqobat muhiti", "Kredit riski darajasi", "Jalb qilingan mablag'lar qiymati"],"ans":0,"exp":"To'g'ri javob: C) Ob-havo sharoiti"},
            {"q":"Inflyatsiyaning namoyon bo'lish shakllari nechta?","opts":["To'rt shakl", "Uch shakl", "Ikki shakl", "Besh shakl"],"ans":2,"exp":"To'g'ri javob: A) Ikki shakl"},
            {"q":"Murakkab foizlar hisoblashda foizlar qanday qo'shiladi?","opts":["Foizlar har yili alohida to'lanadi", "Foizlar faqat muddati tugagach hisoblanadi", "Hisoblangan foizlar asosiy qarz qoldig'iga qo'shilib, keyingi foizlar yangi summadan hisoblanadi", "Foizlar faqat dastlabki summaga hisoblanadi"],"ans":2,"exp":"To'g'ri javob: B) Hisoblangan foizlar asosiy qarz qoldig'iga qo'shilib, keyingi foizlar yangi summadan hisoblanadi"},
            {"q":"Mamlakatimiz pul tizimini vujudga kelishi nechta bosqichga guruhlash maqsadga muvofiq?","opts":["5 bosqich", "4 bosqich", "3 bosqich", "6 bosqich"],"ans":0,"exp":"To'g'ri javob: C) 5 bosqich"},
            {"q":"O'zbekiston hududida birinchi qog'oz pullar qayerda muomalaga kiritilgan?","opts":["Xivada", "Toshkentda", "Samarqandda", "Buxoroda"],"ans":3,"exp":"To'g'ri javob: B) Buxoroda"},
            {"q":"Lokal inflyatsiya nima?","opts":["Alohida mamlakatda yoki mintaqada kuzatiladigan inflyatsiya", "Butun dunyo bo'ylab kuzatiladigan inflyatsiya", "Faqat oziq-ovqat mahsulotlari narxining oshishi", "Yashirin inflyatsiya turi"],"ans":0,"exp":"To'g'ri javob: B) Alohida mamlakatda yoki mintaqada kuzatiladigan inflyatsiya"},
            {"q":"Pul islohotini o'tkazish qanday yo'llar bilan amalga oshirilishi mumkin?","opts":["Faqat valyuta kursini o'zgartirish orqali", "Faqat yangi pul chiqarish orqali", "Faqat denominatsiya orqali", "Denominatsiya, nullifikatsiya, devalvatsiya va revalvatsiya orqali"],"ans":3,"exp":"To'g'ri javob: B) Denominatsiya, nullifikatsiya, devalvatsiya va revalvatsiya orqali"},
            {"q":"Inflyatsiya jamiyatning rivojlanishiga qanday salbiy ta'sir ko'rsatadi?","opts":["Eksportni kuchaytiradi", "Aholining real daromadlari va jamg'armalar qiymatini kamaytiradi, iqtisodiy noaniqlikni oshiradi", "Investitsiyalarni oshiradi", "Ishlab chiqarishni rag'batlantiradi"],"ans":1,"exp":"To'g'ri javob: B) Aholining real daromadlari va jamg'armalar qiymatini kamaytiradi, iqtisodiy noaniqlikni oshiradi"},
            {"q":"Kreditning pullarni muomalaga chiqarish va ularni naqdlashtirish funktsiyasi nima?","opts":["Kredit operatsiyalari bo'yicha foizlar undirish", "Kredit mexanizmi orqali naqd pul muomaladagi kreditlarni naqdlashtirishga imkon berishi", "Kredit resurslarni qayta taqsimlash", "Banklararo resurslar taqsimlash"],"ans":1,"exp":"To'g'ri javob: B) Kredit mexanizmi orqali naqd pul muomaladagi kreditlarni naqdlashtirishga imkon berishi"},
            {"q":"Banknot nima?","opts":["Davlat g'aznasi chiqaradigan qog'oz pul", "Markaziy bank tomonidan chiqariladigan kredit puli", "Xususiy bank vekseli", "Tijorat banki chiqaradigan qarz majburiyati"],"ans":1,"exp":"To'g'ri javob: B) Markaziy bank tomonidan chiqariladigan kredit puli"},
            {"q":"Quyidagilarning qaysi biri kredit pullari hisoblanadi?","opts":["Qog'oz pul (davlat chiqargan)", "Mis tanga, temir tanga, bronza tanga", "Veksel, chek, banknot, kredit plastik karta", "Oltin tanga, kumush tanga"],"ans":2,"exp":"To'g'ri javob: B) Veksel, chek, banknot, kredit plastik karta"},
            {"q":"Chek nima?","opts":["Bank muddatli depoziti", "Tijorat vekseli turi", "Davlat qarz majburiyati", "Bank hisobraqamidan pul to'lash to'g'risida buyruq beruvchi hujjat"],"ans":3,"exp":"To'g'ri javob: B) Bank hisobraqamidan pul to'lash to'g'risida buyruq beruvchi hujjat"},
            {"q":"Kredit kartochkasi nima?","opts":["Davlat ijtimoiy nafaqa kartasi", "Faqat naqd pul olish uchun mo'ljallangan karta", "Plastik tarzda tayyorlangan naqd pul", "Bank tomonidan mijozga kredit chegarasi doirasida to'lov imkoniyatini beruvchi karta"],"ans":3,"exp":"To'g'ri javob: B) Bank tomonidan mijozga kredit chegarasi doirasida to'lov imkoniyatini beruvchi karta"},
            {"q":"Veksel nima?","opts":["Bankdagi depozit hisobi", "Plastik kartochka turi", "Muayyan summani belgilangan muddatda to'lash majburiyatini ifodalovchi qimmatli qog'oz", "Davlat obligatsiyasi"],"ans":2,"exp":"To'g'ri javob: B) Muayyan summani belgilangan muddatda to'lash majburiyatini ifodalovchi qimmatli qog'oz"},
            {"q":"Harakatlanish tartibiga ko'ra plastik kartochkalar necha turga bo'linadi?","opts":["Ikki turga: debetli va kreditli", "To'rt turga", "Besh turga", "Uch turga"],"ans":0,"exp":"To'g'ri javob: A) Ikki turga: debetli va kreditli"},
            {"q":"Pul tizimi deganda nima tushuniladi?","opts":["Qonun bilan belgilangan pul muomalasini tashkil etish shakli", "Markaziy bank faoliyati yig'indisi", "Tijorat banklari kreditlari tizimi", "Faqat muomaladagi naqd pullar majmui"],"ans":0,"exp":"To'g'ri javob: B) Qonun bilan belgilangan pul muomalasini tashkil etish shakli"},
            {"q":"Pul birligi deganda nima tushuniladi?","opts":["Davlat tomonidan belgilangan pul o'lchov birligi (masalan: so'm, dollar)", "Markaziy bank zahiralari", "Muomaladagi barcha pullar yig'indisi", "Kredit tashkilotlari kapitali"],"ans":0,"exp":"To'g'ri javob: B) Davlat tomonidan belgilangan pul o'lchov birligi (masalan: so'm, dollar)"},
            {"q":"Bimetallizm deganda nima tushuniladi?","opts":["Faqat oltin asosidagi pul tizimi", "Ikki metal (oltin va kumush) pul vazifasini bajaradigan tizim", "Qog'oz pullar asosidagi tizim", "Faqat kumush asosidagi pul tizimi"],"ans":1,"exp":"To'g'ri javob: B) Ikki metal (oltin va kumush) pul vazifasini bajaradigan tizim"},
            {"q":"Monometall pul tizimining asosiy belgisi nimadan iborat?","opts":["Qog'oz pullardan foydalanish", "Kredit pullardan foydalanish", "Ikki metaldan (oltin va kumush) foydalanish", "Faqat bitta metal (oltin yoki kumush) umumiy ekvivalent sifatida xizmat qilishi"],"ans":3,"exp":"To'g'ri javob: B) Faqat bitta metal (oltin yoki kumush) umumiy ekvivalent sifatida xizmat qilishi"},
            {"q":"Yevropa ittifoqi qaysi yildan YEVROni naqd pul sifatida muomalaga kiritgan?","opts":["2002-yil", "2005-yil", "1999-yil", "2000-yil"],"ans":0,"exp":"To'g'ri javob: C) 2002-yil"},
            {"q":"O'zbekiston milliy valyutasi 'so'm' muomalaga kiritilganda 'so'm-kupon'ga qanday nisbatda almashtirilgan?","opts":["1:1000 nisbatda", "1:10 nisbatda", "1:1 nisbatda", "1:100 nisbatda"],"ans":2,"exp":"To'g'ri javob: A) 1:1 nisbatda"},
            {"q":"O'zbekiston Respublikasi Konstitutsiyasining qaysi moddasida mustaqil moliya va pul-kredit tizimi belgilab qo'yilgan?","opts":["120-modda", "130-modda", "115-modda", "105-modda"],"ans":2,"exp":"To'g'ri javob: B) 115-modda"},
            {"q":"Oltin tanga standarti bo'yicha kelishuv qaysi shaharda bo'lib o'tgan?","opts":["Bretton-Vuds", "Genuya", "Parij", "London"],"ans":2,"exp":"To'g'ri javob: C) Parij"},
            {"q":"Muomala uchun zaruriy pul miqdori qanday aniqlanadi?","opts":["Tovarlar narxlar yig'indisini pulning aylanish tezligiga bo'lish orqali (Fisher tenglamasi)", "Tijorat banklari tomonidan belgilanadi", "Markaziy bank ixtiyoriy belgilaydi", "Pul massasini YaIMga bo'lish orqali"],"ans":0,"exp":"To'g'ri javob: B) Tovarlar narxlar yig'indisini pulning aylanish tezligiga bo'lish orqali (Fisher tenglamasi)"},
            {"q":"Inflyatsiya so'zining lug'aviy ma'nosi nima?","opts":["Pul miqdorining kamayishi", "Shishish (inflare – shishmoq)", "Qadrsizlanish", "Narxlar oshishi"],"ans":1,"exp":"To'g'ri javob: B) Shishish (inflare – shishmoq)"},
            {"q":"Metall pullarning kelib chiqishi va tarixini o'rganuvchi maxsus fan qaysi?","opts":["Numizmatika", "Geральдика", "Sfragistika", "Epigrafika"],"ans":0,"exp":"To'g'ri javob: A) Numizmatika"},
            {"q":"Tanganing old tomoni nima deyiladi?","opts":["Reversi", "Avers", "Gurt", "Legenda"],"ans":1,"exp":"To'g'ri javob: C) Avers"},
            {"q":"Tanganing orqa tomoni nima deyiladi?","opts":["Gurt", "Legenda", "Revers", "Avers"],"ans":2,"exp":"To'g'ri javob: D) Revers"},
            {"q":"YEVRO pul birligi qaysi mamlakatlarda qo'llaniladi?","opts":["Barcha Yevropa Ittifoqi mamlakatlarida", "Yevropa valyuta ittifoqiga a'zo bo'lgan mamlakatlarda (evrozona)", "Faqat G'arbiy Yevropa mamlakatlarida", "Faqat Germaniya va Fransiyada"],"ans":1,"exp":"To'g'ri javob: B) Yevropa valyuta ittifoqiga a'zo bo'lgan mamlakatlarda (evrozona)"},
            {"q":"Pulning mustaqil almashuv qiymatiga ega ekanligi qaysi operatsiyada namoyon bo'ladi?","opts":["Kredit berishda", "Pulni pulga (valyuta) almashtirish operatsiyasida", "Tovarni sotib olishda", "Depozit ochishda"],"ans":1,"exp":"To'g'ri javob: B) Pulni pulga (valyuta) almashtirish operatsiyasida"},
            {"q":"Pulning mohiyati nimada namoyon bo'ladi?","opts":["Faqat muomala vositasi sifatida", "Faqat jamg'arish vositasi sifatida", "Faqat hisob birligi sifatida", "Pul umumiy ekvivalent sifatida tovarlarning qiymatini ifodalashida"],"ans":3,"exp":"To'g'ri javob: B) Pul umumiy ekvivalent sifatida tovarlarning qiymatini ifodalashida"},
            {"q":"Agar davlat eski pulni butunlay bekor qilib, yangisini muomalaga kiritsa, bu qanday pul islohoti?","opts":["Revalvatsiya", "Devalvatsiya", "Nullifikatsiya", "Denominatsiya"],"ans":2,"exp":"To'g'ri javob: C) Nullifikatsiya"},
            {"q":"YEVRO pul birligi elektron shaklda qachondan boshlab muomalaga kiritildi?","opts":["2001-yil 1-yanvar", "1995-yil 1-yanvar", "1999-yil 1-yanvar", "1997-yil 1-yanvar"],"ans":2,"exp":"To'g'ri javob: C) 1999-yil 1-yanvar"},
            {"q":"'So'm ko'pon' nechanchi yilda muomalaga kiritildi?","opts":["1991-yil", "1994-yil", "1993-yil", "1995-yil"],"ans":2,"exp":"To'g'ri javob: B) 1993-yil"},
            {"q":"Iqtisodiy turg'unlik va yuqori inflyatsiyaning bir paytda kuzatilishi qanday holat?","opts":["Giperinflyatsiya", "Stagflatsiya", "Agflyatsiya", "Deflyatsiya"],"ans":1,"exp":"To'g'ri javob: C) Stagflatsiya"},
            {"q":"Pulning mohiyati qaysi funktsiyalarda namoyon bo'ladi?","opts":["Faqat to'lov funktsiyasida", "Qiymat o'lchovi, muomala vositasi, jamg'arish, to'lov va jahon puli funktsiyalarida", "Faqat muomala va to'lov vositasi funktsiyasida", "Faqat jamg'arish funktsiyasida"],"ans":1,"exp":"To'g'ri javob: B) Qiymat o'lchovi, muomala vositasi, jamg'arish, to'lov va jahon puli funktsiyalarida"},
            {"q":"Pulning muomala vositasi funktsiyasida qanday pullar ishtirok etadi?","opts":["Faqat qog'oz pullar", "Faqat ideal pullar", "Faqat kredit pullar", "Haqiqiy (real) naqd pullar"],"ans":3,"exp":"To'g'ri javob: C) Haqiqiy (real) naqd pullar"},
            {"q":"Pulning mohiyati nimada?","opts":["Pul davlat tomonidan chiqariladigan belgi", "Pul faqat boylik ramzi", "Pul umumiy tovar ekvivalenti sifatida boshqa barcha tovarlar qiymatini ifodalaydi", "Pul faqat to'lov vositasi"],"ans":2,"exp":"To'g'ri javob: B) Pul umumiy tovar ekvivalenti sifatida boshqa barcha tovarlar qiymatini ifodalaydi"},
            {"q":"Pulning qadrsizlanishi qaysi pul muomalasida ro'y beradi?","opts":["Haqiqiy metallik pullar muomalasida", "Oltin tanga standartida", "Qog'oz va kredit pullar muomalasida", "Barter iqtisodiyotida"],"ans":2,"exp":"To'g'ri javob: C) Qog'oz va kredit pullar muomalasida"},
            {"q":"Pulning iqtisodiyotdagi roli nimada?","opts":["Faqat tovar ayirboshlashni osonlashtirish", "Faqat jamg'arish vositasi bo'lish", "Iqtisodiy munosabatlarni tartibga solish, resurslarni taqsimlash, iqtisodiy o'sishni rag'batlanti...", "Faqat davlat byudjetini moliyalashtirish"],"ans":2,"exp":"To'g'ri javob: B) Iqtisodiy munosabatlarni tartibga solish, resurslarni taqsimlash, iqtisodiy o'sishni rag'batlantirish"},
            {"q":"Pulning zarurligi nimada?","opts":["Davlat buyrug'i taqozo etgani uchun", "Xalqaro savdo uchun zarur", "Soliq yig'ish uchun zarur", "Tovar ishlab chiqarish va ayirboshlash rivojlanishi, mehnat taqsimoti chuqurlashishi natijasida z..."],"ans":3,"exp":"To'g'ri javob: B) Tovar ishlab chiqarish va ayirboshlash rivojlanishi, mehnat taqsimoti chuqurlashishi natijasida zarurat tug'ilgani"},
            {"q":"Pulning turlarini ko'rsating?","opts":["Faqat qog'oz va elektron pullar", "Faqat naqd va naqdsiz pullar", "Faqat milliy va xorijiy valyutalar", "Tovar (natural) pullar, metall pullar, qog'oz pullar va kredit pullar"],"ans":3,"exp":"To'g'ri javob: B) Tovar (natural) pullar, metall pullar, qog'oz pullar va kredit pullar"},
            {"q":"Naqdsiz pul aylanishining naqd pulga nisbatan asosiy afzalliklari nima?","opts":["Faqat tezroq", "Xarajatlarni kamaytirish, xavfsizlik, shaffoflik va nazorat qulayligi", "Faqat yirik summalar uchun qulay", "Faqat xalqaro to'lovlar uchun qulay"],"ans":1,"exp":"To'g'ri javob: B) Xarajatlarni kamaytirish, xavfsizlik, shaffoflik va nazorat qulayligi"},
            {"q":"Pul muomalasi qonuni nima?","opts":["Inflyatsiyani tartibga soluvchi qonun", "Pul massasini ko'paytirish qonuni", "Markaziy bank chiqaradigan qonun", "Muomalada bo'lishi zarur bo'lgan pul miqdorini belgilovchi iqtisodiy qonun (MV=PT)"],"ans":3,"exp":"To'g'ri javob: B) Muomalada bo'lishi zarur bo'lgan pul miqdorini belgilovchi iqtisodiy qonun (MV=PT)"},
            {"q":"Pul massasi nima?","opts":["Faqat muomaladagi naqd pullar miqdori", "Iqtisodiyotda mavjud bo'lgan barcha to'lov vositalari yig'indisi", "Davlat byudjeti daromadlari miqdori", "Faqat bank depozitlari miqdori"],"ans":1,"exp":"To'g'ri javob: B) Iqtisodiyotda mavjud bo'lgan barcha to'lov vositalari yig'indisi"},
            {"q":"Pulning barqarorligi deganda nima tushuniladi?","opts":["Pulning miqdori o'zgarmasligi", "Valyuta kursining o'zgarmasligi", "Foiz stavkasining o'zgarmasligi", "Pulning sotib olish qobiliyatining, ya'ni tovar va xizmatlar miqdoriga nisbatining barqarorligi"],"ans":3,"exp":"To'g'ri javob: B) Pulning sotib olish qobiliyatining, ya'ni tovar va xizmatlar miqdoriga nisbatining barqarorligi"},
            {"q":"Pulning haddan ziyod muomalaga chiqarilishi qanday oqibatlarga olib keladi?","opts":["Inflyatsiyaga, narxlarning oshishiga va pulning qadrsizlanishiga olib keladi", "Eksportni kuchaytiradi", "Iqtisodiy o'sishga olib keladi", "Investitsiyalarni jalb qiladi"],"ans":0,"exp":"To'g'ri javob: B) Inflyatsiyaga, narxlarning oshishiga va pulning qadrsizlanishiga olib keladi"},
            {"q":"To'lov topshiriqnomasi bo'yicha hisob-kitoblarning asosiy afzalligi nima?","opts":["Sotuvchiga kuchli himoya beradi", "Faqat katta summalar uchun mos", "Oldindan to'lov kafolati beradi", "Oddiy, tezkor va keng qo'llanadigan hisob-kitob shakli"],"ans":3,"exp":"To'g'ri javob: B) Oddiy, tezkor va keng qo'llanadigan hisob-kitob shakli"},
            {"q":"AQSHda pul ta'minotini qaysi bank nazorat qiladi?","opts":["Citibank", "Bank of America", "Federal Rezerv tizimi (FED)", "JPMorgan Chase"],"ans":2,"exp":"To'g'ri javob: C) Federal Rezerv tizimi (FED)"},
            {"q":"Miqdoriy pul nazariyasining asoschilariga kimlar kiradi?","opts":["K.Marks va F.Engels", "J.M.Keyns va M.Fridmen", "A.Smit va D.Rikardo", "D.Yum, D.Rikardo, I.Fisher"],"ans":3,"exp":"To'g'ri javob: B) D.Yum, D.Rikardo, I.Fisher"},
            {"q":"Pul multiplikatori qanday aniqlanadi?","opts":["Pul massasini YaIMga bo'lish orqali", "YaIMni pul massasiga bo'lish orqali", "Majburiy rezervlar normasi bo'yicha: 1/r", "Inflyatsiya darajasini foiz stavkasiga bo'lish orqali"],"ans":2,"exp":"To'g'ri javob: C) Majburiy rezervlar normasi bo'yicha: 1/r"},
            {"q":"Oltinni demonetizatsiya qilish deganda nimani tushunasiz?","opts":["Oltin tangalarni zarbxonada eritish", "Oltinni ko'paytirish", "Oltin zahiralarini kamaytirish", "Oltinning pul funktsiyasidan mahrum qilinishi va oddiy tovar-metall maqomiga tushirilishi"],"ans":3,"exp":"To'g'ri javob: B) Oltinning pul funktsiyasidan mahrum qilinishi va oddiy tovar-metall maqomiga tushirilishi"},
            {"q":"Kreditlash jarayoni qanday tamoyillar orqali amalga oshiriladi?","opts":["Faqat foizlilik va garov", "Faqat ishonch tamoyili", "Qaytarishlilik, muddatlilik, to'lovlilik, ta'minlanganlik va maqsadlilik", "Faqat qaytarishlilik va muddatlilik"],"ans":2,"exp":"To'g'ri javob: B) Qaytarishlilik, muddatlilik, to'lovlilik, ta'minlanganlik va maqsadlilik"},
            {"q":"Kredit sub'ektlari kimlar?","opts":["Faqat davlat muassasalari", "Kreditor (qarz beruvchi) va qarz oluvchi", "Faqat jismoniy shaxslar", "Faqat tijorat banklari"],"ans":1,"exp":"To'g'ri javob: B) Kreditor (qarz beruvchi) va qarz oluvchi"},
            {"q":"Kredit ob'ektlari nima?","opts":["Kredit ishtirokchilari", "Kredit shartnomasi shartlari", "Kredit vositasida moliyalashtirilayotgan tovarlar, xizmatlar, moliyaviy ehtiyojlar yoki loyihalar", "Kredit beruvchi banklar"],"ans":2,"exp":"To'g'ri javob: B) Kredit vositasida moliyalashtirilayotgan tovarlar, xizmatlar, moliyaviy ehtiyojlar yoki loyihalar"},
            {"q":"Iste'mol krediti deganda nimani tushunasiz?","opts":["Davlatga beriladigan kredit", "Faqat ipoteka krediti", "Korxonalarga ishlab chiqarish uchun beriladigan kredit", "Aholiga shaxsiy ehtiyojlar (tovar, xizmat sotib olish) uchun beriladigan kredit"],"ans":3,"exp":"To'g'ri javob: B) Aholiga shaxsiy ehtiyojlar (tovar, xizmat sotib olish) uchun beriladigan kredit"},
            {"q":"Xalqaro kredit nima?","opts":["Faqat XVF kreditlari", "Turli mamlakatlar sub'ektlari o'rtasida, jumladan xalqaro moliya institutlari bilan tuzilgan kred...", "Tijorat banklari o'rtasidagi kredit", "Faqat hukumat kreditlari"],"ans":1,"exp":"To'g'ri javob: B) Turli mamlakatlar sub'ektlari o'rtasida, jumladan xalqaro moliya institutlari bilan tuzilgan kredit munosabatlari"},
            {"q":"Respublikamizda asosiy o'rinni egallovchi kredit shakli qaysi?","opts":["Bank krediti", "Tijorat krediti", "Iste'mol krediti", "Xalqaro kredit"],"ans":0,"exp":"To'g'ri javob: C) Bank krediti"},
            {"q":"Tijorat kreditining ob'ekti nima?","opts":["Pul mablag'lari", "Ko'chmas mulk", "Qimmatli qog'ozlar", "Tovarlar – bir korxona boshqasiga kredit shaklida (to'lov muddatini kechiktirib) beriladigan tova..."],"ans":3,"exp":"To'g'ri javob: B) Tovarlar – bir korxona boshqasiga kredit shaklida (to'lov muddatini kechiktirib) beriladigan tovarlar"},
            {"q":"Kreditni to'lash manbalariga ko'ra qanday turlarga ajratiladi?","opts":["Daromad, amortizatsiya, aktivlarni sotish va yangi kredit olish manbalaridan to'lanadigan kreditlar", "Muddatli va muddatidan oldin to'lanadigan", "Foizli va foizsiz kreditlar", "Garovli va garovsiz kreditlar"],"ans":0,"exp":"To'g'ri javob: B) Daromad, amortizatsiya, aktivlarni sotish va yangi kredit olish manbalaridan to'lanadigan kreditlar"},
            {"q":"I.Fisherning almashuv tenglamasini ko'rsating:","opts":["P = M / V × T", "MV = PT (pul massasi × aylanish tezligi = narx darajasi × tovarlar miqdori)", "GDP = C + I + G + NX", "MV = GDP / P"],"ans":1,"exp":"To'g'ri javob: A) MV = PT (pul massasi × aylanish tezligi = narx darajasi × tovarlar miqdori)"},
            {"q":"Pul massasi 1200 mlrd dollar, YaIM 3000 mlrd dollar bo'lsa, monetizatsiya darajasi qancha?","opts":["0.2 (20%)", "0.5 (50%)", "0.4 (40%)", "2.5 (250%)"],"ans":2,"exp":"To'g'ri javob: B) 0.4 (40%)"},
            {"q":"To'lovlarning kalendar ketma-ketligi qo'llanilmayotgan davlatni ko'rsating:","opts":["O'zbekiston", "AQSh", "Germaniya", "Rossiya"],"ans":1,"exp":"To'g'ri javob: C) AQSh"},
            {"q":"Pul aylanmasining asosiy qismini nima tashkil etadi?","opts":["Kredit aylanmasi", "Valyuta aylanmasi", "Naqd pul aylanmasi", "Naqdsiz pul aylanmasi"],"ans":3,"exp":"To'g'ri javob: B) Naqdsiz pul aylanmasi"},
            {"q":"Monetizatsiya koeffitsienti nimani ko'rsatadi?","opts":["Pul massasining YaIMga nisbatini – iqtisodiyotning pul bilan ta'minlanganligini", "Inflyatsiya darajasini", "Foiz stavkasi darajasini", "Valyuta kursi barqarorligini"],"ans":0,"exp":"To'g'ri javob: B) Pul massasining YaIMga nisbatini – iqtisodiyotning pul bilan ta'minlanganligini"},
            {"q":"Kvazi-pullar nima?","opts":["Xorijiy valyutalar", "Markaziy bank zaxiralari", "Muddatli depozitlar va jamg'arma hisobraqamlari – naqd pulga yaqin, lekin bevosita to'lovda ishla...", "Muomaladagi naqd pullar"],"ans":2,"exp":"To'g'ri javob: B) Muddatli depozitlar va jamg'arma hisobraqamlari – naqd pulga yaqin, lekin bevosita to'lovda ishlatilmaydigan aktivlar"},
            {"q":"Dastlabki tangalar qachon zarb etilgan?","opts":["Miloddan avvalgi V asrda", "Miloddan avvalgi III asrda", "Miloddan avvalgi VII asrda", "Miloddan avvalgi X asrda"],"ans":2,"exp":"To'g'ri javob: B) Miloddan avvalgi VII asrda"},
            {"q":"Dastlabki tangalar qayerda zarb etilgan?","opts":["Qadimgi Rimda", "Qadimgi Xitoyda", "Qadimgi Yunonistonda", "Kichik Osiyo (Lidiya)da"],"ans":3,"exp":"To'g'ri javob: C) Kichik Osiyo (Lidiya)da"},
            {"q":"O'zbekiston hududida qog'oz pullar qachon muomalaga chiqarilgan?","opts":["XVII asrda", "XX asrda", "XVIII asrda", "XIX asrda (Buxoro amirligi davrida)"],"ans":3,"exp":"To'g'ri javob: C) XIX asrda (Buxoro amirligi davrida)"},
            {"q":"Buxoro amirligining qog'oz pullari nechanchi yil bekor qilingan?","opts":["1930-yil", "1924-yil", "1918-yil", "1920-yil"],"ans":1,"exp":"To'g'ri javob: C) 1924-yil"},
            {"q":"Pulning muomala vositasi funktsiyasi qachon namoyon bo'ladi?","opts":["Tovar sotib olinayotgan vaqtda – pul tovar bilan bir vaqtda harakatlanayotganda", "Kredit berilganda", "Tovar saqlanganda", "Soliq to'langanda"],"ans":0,"exp":"To'g'ri javob: B) Tovar sotib olinayotgan vaqtda – pul tovar bilan bir vaqtda harakatlanayotganda"},
            {"q":"Vaqtincha foydalanilmayotgan pullar qanday vazifani bajaradi?","opts":["Jamg'arish (boylik to'plash) vositasi", "Muomala vositasi", "Jahon puli", "To'lov vositasi"],"ans":0,"exp":"To'g'ri javob: B) Jamg'arish (boylik to'plash) vositasi"},
            {"q":"Nominal pul nazariyasi tarafdorlarining kamchiligi nimada?","opts":["Kredit pullarni inkor etadi", "Pulning qiymat asosini inkor etib, uni faqat davlat belgisi sifatida ko'radi, bu esa haqiqiy iqti...", "Inflyatsiyani inobatga olmaydi", "Metall pullarni e'tiborga olmaydi"],"ans":1,"exp":"To'g'ri javob: B) Pulning qiymat asosini inkor etib, uni faqat davlat belgisi sifatida ko'radi, bu esa haqiqiy iqtisodiy munosabatlarni tushuntira olmaydi"},
            {"q":"Bozor iqtisodiyoti sharoitida pulning sotib olish qobiliyati nimaga bog'liq?","opts":["Faqat oltin zahiralariga", "Bozordagi tovarlar miqdori va narxlar darajasiga, ya'ni inflyatsiya va taklif holatiga", "Faqat valyuta kursiga", "Faqat davlat belgilaydigan qiymatga"],"ans":1,"exp":"To'g'ri javob: B) Bozordagi tovarlar miqdori va narxlar darajasiga, ya'ni inflyatsiya va taklif holatiga"},
            {"q":"Miqdoriy pul nazariyasida 'kassa qoldig'i' ta'limotini kim ilgari surgan?","opts":["M.Fridmen", "A.Marshall", "I.Fisher", "J.M.Keyns"],"ans":1,"exp":"To'g'ri javob: C) A.Marshall"},
            {"q":"O'zbekiston tijorat banklarida elektron to'lov tizimi qachon joriy etildi?","opts":["2000-yil", "1997-yil", "1994-yil", "2005-yil"],"ans":1,"exp":"To'g'ri javob: B) 1997-yil"},
            {"q":"To'lov topshiriqnomasi bu:","opts":["Sotuvchining bankka to'lov olish buyrug'i", "To'lovchining o'z bankiga boshqa shaxs hisobiga pul o'tkazishni buyuruvchi hujjati", "Garov hujjati", "Akkreditiv turi"],"ans":1,"exp":"To'g'ri javob: B) To'lovchining o'z bankiga boshqa shaxs hisobiga pul o'tkazishni buyuruvchi hujjati"},
            {"q":"To'lov talabnoma bu:","opts":["Mol yetkazib beruvchining (kreditorning) to'lovchining bankiga to'lovni amalga oshirishni talab q...", "Kredit shartnomasi sharti", "Markaziy bank direktivi", "To'lovchi taqdim etadigan hujjat"],"ans":0,"exp":"To'g'ri javob: B) Mol yetkazib beruvchining (kreditorning) to'lovchining bankiga to'lovni amalga oshirishni talab qiluvchi hujjati"},
            {"q":"Akkreditivning shakllari qaysi javobda to'g'ri keltirilgan?","opts":["Oddiy va murakkab", "Muddatli va muddatsiz", "Milliy va xalqaro", "Qoplanuvchi va qoplanmaydigan, qaytariladigan va qaytarilmaydigan, tasdiqlangan va tasdiqlanmagan"],"ans":3,"exp":"To'g'ri javob: B) Qoplanuvchi va qoplanmaydigan, qaytariladigan va qaytarilmaydigan, tasdiqlangan va tasdiqlanmagan"},
            {"q":"Aktseptli to'lov talabnomalarida qanday tartib qo'llaniladi?","opts":["To'lovchi hujjatlarni ko'rib chiqib, rozilik (aktsept) berganidan keyingina to'lov amalga oshiriladi", "Markaziy bank ruxsati kerak", "Sud qarorisiz to'lov amalga oshiriladi", "To'lov avtomatik amalga oshiriladi"],"ans":0,"exp":"To'g'ri javob: B) To'lovchi hujjatlarni ko'rib chiqib, rozilik (aktsept) berganidan keyingina to'lov amalga oshiriladi"},
            {"q":"Aktseptsiz to'lov talabnomalarida qanday tartib qo'llaniladi?","opts":["Faqat xorijiy to'lovlarda qo'llaniladi", "Sud qaroriga asosan to'lov amalga oshiriladi", "To'lovchi roziligisiz to'lov amalga oshiriladi (qonunda belgilangan hollarda)", "To'lovchi albatta rozilik berishi kerak"],"ans":2,"exp":"To'g'ri javob: A) To'lovchi roziligisiz to'lov amalga oshiriladi (qonunda belgilangan hollarda)"},
            {"q":"Inkasso topshiriqnomasini bankka kimlar taqdim etishga haqli?","opts":["Faqat jismoniy shaxslar", "Soliq organlari, sudlar, bojxona, notariuslar, majburiy ijro byurosi va boshqa vakolatli organlar", "Faqat Markaziy bank", "Faqat tijorat banklari"],"ans":1,"exp":"To'g'ri javob: B) Soliq organlari, sudlar, bojxona, notariuslar, majburiy ijro byurosi va boshqa vakolatli organlar"},
            {"q":"Inkasso topshiriqnomasi nima?","opts":["Akkreditiv ochish uchun ariza", "Sotuvchining to'lovni kafolatlash hujjati", "Kredit olish uchun ariza", "To'lovni majburan undirish uchun vakolatli shaxslar tomonidan bankka beriladigan hujjat"],"ans":3,"exp":"To'g'ri javob: B) To'lovni majburan undirish uchun vakolatli shaxslar tomonidan bankka beriladigan hujjat"},
            {"q":"Naqd pulsiz hisob-kitoblarning eng ko'p qo'llaniladigan shakli bu:","opts":["To'lov topshiriqnomasi", "Akkreditiv", "Chek", "Inkasso"],"ans":0,"exp":"To'g'ri javob: C) To'lov topshiriqnomasi"},
            {"q":"Bimetallizm tizimining asosiy xususiyati to'g'ri keltirilgan qator qaysi?","opts":["Faqat oltin muomala qiladi", "Oltin ham, kumush ham qonuniy to'lov vositasi sifatida bir vaqtda muomalada bo'ladi", "Qog'oz pullar metallga almashtiriladi", "Faqat kumush muomala qiladi"],"ans":1,"exp":"To'g'ri javob: B) Oltin ham, kumush ham qonuniy to'lov vositasi sifatida bir vaqtda muomalada bo'ladi"},
            {"q":"Pul tizimi deganda nima tushuniladi?","opts":["Faqat Markaziy bank faoliyati", "Faqat muomaladagi naqd pullar majmui", "Bank operatsiyalari to'plami", "Qonun bilan belgilangan pul muomalasini tashkil etish shakli"],"ans":3,"exp":"To'g'ri javob: B) Qonun bilan belgilangan pul muomalasini tashkil etish shakli"},
            {"q":"Haqiqiy pullar to'g'ri keltirilgan qator qaysi?","opts":["Qog'oz pullar va banknotlar", "Oltin va kumush tangalar – o'z qiymati bor metaldan yasalgan pullar", "Kredit kartochkalar", "Chek va veksel"],"ans":1,"exp":"To'g'ri javob: B) Oltin va kumush tangalar – o'z qiymati bor metaldan yasalgan pullar"},
            {"q":"Monometallizm tizimining asosiy xususiyati to'g'ri keltirilgan qator qaysi?","opts":["Qog'oz pullar muomala qiladi", "Faqat bitta metal (oltin yoki kumush) umumiy ekvivalent sifatida xizmat qiladi", "Kredit pullar muomala qiladi", "Ikkita metall muomala qiladi"],"ans":1,"exp":"To'g'ri javob: B) Faqat bitta metal (oltin yoki kumush) umumiy ekvivalent sifatida xizmat qiladi"},
            {"q":"Oltin tanga standartining asosiy xususiyatlari to'g'ri keltirilgan qator qaysi?","opts":["Faqat oltin quymalar muomalada bo'ladi", "Oltin tangalar muomalada bo'ladi, qog'oz pullar oltinga erkin almashtiriladi, oltin erkin olib ki...", "Qog'oz pullar faqat milliy hududda qo'llaniladi", "Faqat qog'oz pullar muomala qiladi"],"ans":1,"exp":"To'g'ri javob: B) Oltin tangalar muomalada bo'ladi, qog'oz pullar oltinga erkin almashtiriladi, oltin erkin olib kiriladi va olib chiqiladi"},
            {"q":"Oltin quyma standartining asosiy xususiyatlari to'g'ri keltirilgan qator qaysi?","opts":["Kichik miqdordagi oltin tangalar muomala qilmaydi; qog'oz pullar faqat yirik miqdorda (quyma hajm...", "Oltin pullar erkin eksport qilinadi", "Qog'oz pullar to'liq oltinga almashtiriladi", "Oltin tangalar muomalada bo'ladi"],"ans":0,"exp":"To'g'ri javob: B) Kichik miqdordagi oltin tangalar muomala qilmaydi; qog'oz pullar faqat yirik miqdorda (quyma hajmida) oltinga almashtiriladi"},
            {"q":"Oltin deviz standartining asosiy xususiyatlari to'g'ri keltirilgan qator qaysi?","opts":["Oltin tangalar muomalada bo'ladi", "Barcha valyutalar erkin oltinga almashtiriladi", "Milliy valyuta bevosita oltinga emas, balki boshqa valyutaga (devizga) almashtiriladi, u esa olti...", "Oltin quymalar muomalada bo'ladi"],"ans":2,"exp":"To'g'ri javob: B) Milliy valyuta bevosita oltinga emas, balki boshqa valyutaga (devizga) almashtiriladi, u esa oltinga almashtiriladi"},
            {"q":"Qog'oz-kredit pul tizimi qaysi yillardan boshlab xalqaro va mahalliy hisob-kitoblarda faoliyat yurita boshladi?","opts":["1944-yildan", "1930-yillardan", "1990-yillardan", "1971-1976-yillardan (Yamayka tizimidan)"],"ans":3,"exp":"To'g'ri javob: C) 1971-1976-yillardan (Yamayka tizimidan)"},
            {"q":"Qaysi standartda oltinning umumiy ekvivalent sifatida muomaladagi harakati to'xtatildi?","opts":["Oltin deviz standartida", "Oltin quyma standartida", "Oltin tanga standartida", "Yamayka valyuta tizimida"],"ans":3,"exp":"To'g'ri javob: D) Yamayka valyuta tizimida"},
            {"q":"Oltin demonetizatsiyasi nima?","opts":["Oltin narxini pasaytirish", "Oltin zahiralarini oshirish", "Oltin ishlab chiqarishni to'xtatish", "Oltinning pul funktsiyalarini yo'qotib, oddiy tovar-metallga aylanishi (Yamayka tizimida rasmiy t..."],"ans":3,"exp":"To'g'ri javob: B) Oltinning pul funktsiyalarini yo'qotib, oddiy tovar-metallga aylanishi (Yamayka tizimida rasmiy tan olingan)"},
            {"q":"Mamlakatimizda nechta pul agregati amal qiladi?","opts":["Ikki: M0 va M1", "Uch: M0, M1 va M2", "Besh: M0, M1, M2, M3 va M4", "To'rt: M0, M1, M2 va M3"],"ans":3,"exp":"To'g'ri javob: C) To'rt: M0, M1, M2 va M3"},
            {"q":"Banknotalar qaysi organ tomonidan muomalaga chiqariladi?","opts":["Hukumat tomonidan", "Markaziy bank tomonidan", "Moliya vazirligi tomonidan", "Tijorat banklari tomonidan"],"ans":1,"exp":"To'g'ri javob: B) Markaziy bank tomonidan"},
            {"q":"Oraliq 'so'm kupon' muomalada qachongacha to'lov vositasini bajardi?","opts":["1994-yil 1-iyuligacha", "1994-yil 1-oktyabrgacha", "1993-yil oxirigacha", "1995-yil boshigacha"],"ans":1,"exp":"To'g'ri javob: C) 1994-yil 1-oktyabrgacha"},
            {"q":"Inflyatsiyani keltirib chiqaruvchi omil noto'g'ri keltirilgan qator qaysi?","opts":["Byudjet taqchilligini pul emissiyasi orqali qoplash", "Ishlab chiqarish xarajatlarining oshishi", "Pul massasining oshishi", "YaIMning oshishi (tovar va xizmatlar taklifining oshishi)"],"ans":3,"exp":"To'g'ri javob: C) YaIMning oshishi (tovar va xizmatlar taklifining oshishi)"},
            {"q":"Inflyatsiya tushunchasi iqtisodiy termin sifatida qachon kirib kelgan?","opts":["XVIII asrda", "XIX asrda", "XVII asrda", "XX asrda (1-jahon urushi davrida)"],"ans":1,"exp":"To'g'ri javob: B) XIX asrda"},
            {"q":"Inflyatsiya tushunchasini iqtisodiy termin sifatida fanga kim olib kirgan?","opts":["M.Fridmen", "Amerika iqtisodchilari (AQSh fuqarolar urushi davri)", "K.Marks", "J.M.Keyns"],"ans":1,"exp":"To'g'ri javob: C) Amerika iqtisodchilari (AQSh fuqarolar urushi davri)"},
            {"q":"Quyidagilardan qaysi biri inflyatsiyaning shakliga kirmaydi?","opts":["Lokal inflyatsiya", "Ochiq inflyatsiya", "Deflyatsiya", "Yashirin inflyatsiya"],"ans":2,"exp":"To'g'ri javob: C) Deflyatsiya"},
            {"q":"Giperinflyatsiya sharoitida pul muomalasi qanday holatda bo'ladi?","opts":["Xorijiy valyuta taqiqlanadi", "Yangi pul emissiyasi to'xtatiladi", "Pul tizimi amalda ishlamaydi, barter munosabatlari kengayadi, puldan qochish holati kuzatiladi", "Barqaror va tartibli"],"ans":2,"exp":"To'g'ri javob: B) Pul tizimi amalda ishlamaydi, barter munosabatlari kengayadi, puldan qochish holati kuzatiladi"},
            {"q":"Inflyatsiyaga qarshi qanday siyosat mavjud?","opts":["Deflyatsion siyosat va daromadlar siyosati", "Faqat pul-kredit siyosati", "Faqat byudjet-soliq siyosati", "Faqat valyuta siyosati"],"ans":0,"exp":"To'g'ri javob: B) Deflyatsion siyosat va daromadlar siyosati"},
            {"q":"Yevro hudud uchun YeMB tomonidan belgilangan inflyatsiya darajasining yillik normasi qancha?","opts":["1 foizdan past", "10 foiz", "5 foiz", "2 foizga yaqin, lekin undan oshmaydigan"],"ans":3,"exp":"To'g'ri javob: B) 2 foizga yaqin, lekin undan oshmaydigan"},
            {"q":"XVF ekspertlarining fikriga ko'ra inflyatsiyaning oylik darajasi necha foizdan oshishi giperinflyatsiya?","opts":["20 foiz", "50 foiz", "100 foiz", "10 foiz"],"ans":1,"exp":"To'g'ri javob: C) 50 foiz"},
            {"q":"Pul islohotini o'tkazishning zarurligi nimada?","opts":["Pul tizimining inqirozi, giperinflyatsiya yoki davlat mustaqilligiga erishish holatlarida pul muo...", "Xalqaro moliya tashkilotlari talabi bo'lganda", "Faqat yangi hukumat kelganda", "Har 10 yilda bir marta"],"ans":0,"exp":"To'g'ri javob: B) Pul tizimining inqirozi, giperinflyatsiya yoki davlat mustaqilligiga erishish holatlarida pul muomalasini barqarorlashtirish zarurligi"},
            {"q":"Pul massasi bu:","opts":["Muayyan davrda iqtisodiyotda muomalada bo'lgan barcha to'lov vositalari yig'indisi (M0+M1+M2+M3)", "Faqat bank depozitlari", "Faqat naqd pullar", "Davlat byudjeti daromadlari"],"ans":0,"exp":"To'g'ri javob: B) Muayyan davrda iqtisodiyotda muomalada bo'lgan barcha to'lov vositalari yig'indisi (M0+M1+M2+M3)"},
            {"q":"Denominatsiya bu:","opts":["Valyuta kursini o'zgartirish", "Inflyatsiyaga qarshi kurash siyosati", "Muomaladagi pullarni yangi pul bilan almashtirish", "Pul birligining nominal qiymatini qisqartirish – nollarni kamaytirish orqali pul islohotini o'tka..."],"ans":3,"exp":"To'g'ri javob: B) Pul birligining nominal qiymatini qisqartirish – nollarni kamaytirish orqali pul islohotini o'tkazish"},
            {"q":"Kreditning tamoyillari qanday javobda to'liq keltirilgan?","opts":["Foizlilik va ishonchlilik", "Qaytarishlilik, muddatlilik, to'lovlilik, ta'minlanganlik va maqsadlilik", "Qaytarishlilik, foizlilik", "Faqat muddatlilik va garovlilik"],"ans":1,"exp":"To'g'ri javob: B) Qaytarishlilik, muddatlilik, to'lovlilik, ta'minlanganlik va maqsadlilik"},
            {"q":"O'zbekistonda bank krediti muddatiga ko'ra qanday kreditlarga bo'linadi?","opts":["Faqat qisqa va uzoq muddatli", "Besh turga bo'linadi", "Faqat qisqa muddatli", "Qisqa muddatli (1 yilgacha), o'rta muddatli (1-3 yil), uzoq muddatli (3 yildan ortiq)"],"ans":3,"exp":"To'g'ri javob: B) Qisqa muddatli (1 yilgacha), o'rta muddatli (1-3 yil), uzoq muddatli (3 yildan ortiq)"},
            {"q":"Bank kreditida kreditning ob'ekti nima hisoblanadi?","opts":["Bank aksiyalari", "Bank xodimlari", "Bank binosi va uskunalari", "Ssuda kapitali – vaqtincha bo'sh pul mablag'lari"],"ans":3,"exp":"To'g'ri javob: B) Ssuda kapitali – vaqtincha bo'sh pul mablag'lari"},
            {"q":"Tijorat kreditida kreditning ob'ekti nima hisoblanadi?","opts":["Ko'chmas mulk", "Pul mablag'lari", "Tovarlar – bir korxona boshqasiga muddatli to'lov sharti bilan beriladigan tovarlar", "Qimmatli qog'ozlar"],"ans":2,"exp":"To'g'ri javob: B) Tovarlar – bir korxona boshqasiga muddatli to'lov sharti bilan beriladigan tovarlar"},
            {"q":"Kredit bahosini belgilovchi asosiy omil qaysi?","opts":["Faqat bank siyosati", "Faqat Markaziy bank stavkasi", "Faqat qarz oluvchining talabi", "Jalb qilingan resurslar qiymati, risk darajasi, inflyatsiya, raqobat va bozor konyunkturasi"],"ans":3,"exp":"To'g'ri javob: B) Jalb qilingan resurslar qiymati, risk darajasi, inflyatsiya, raqobat va bozor konyunkturasi"},
            {"q":"Oddiy foizlar qanday hisoblanadi?","opts":["Foizlar faqat muddati tugagach hisoblanadi", "Foizlar asosiy qarz qoldig'iga qo'shilib hisoblanadi", "Foizlar faqat dastlabki (asosiy) qarz summasiga hisoblanadi, qo'shilmaydi", "Foizlar har kuni hisoblanadi"],"ans":2,"exp":"To'g'ri javob: B) Foizlar faqat dastlabki (asosiy) qarz summasiga hisoblanadi, qo'shilmaydi"},
            {"q":"Kreditlar bo'yicha qaysi foiz stavkasida inflyatsiya darajasi hisobga olinadi?","opts":["Real foiz stavkasida", "Nominal foiz stavkasida", "Diskont stavkasida", "LIBOR stavkasida"],"ans":0,"exp":"To'g'ri javob: B) Real foiz stavkasida"},
            {"q":"Kredit bahosining funktsiyalari to'g'ri keltirilgan qator qaysi?","opts":["Taqsimlash, rag'batlantirish va nazorat funktsiyalari", "Faqat daromad keltirish", "Faqat rag'batlantirish", "Faqat nazorat"],"ans":0,"exp":"To'g'ri javob: B) Taqsimlash, rag'batlantirish va nazorat funktsiyalari"},
            {"q":"AQShda kredit bahosi shakllanishining qaysi modelida jalb qilingan mablag'lar va operatsion xarajatlar hisobga olinadi?","opts":["LIBOR modeli", "Diskont modeli", "'Xarajatlar plus' modeli (Cost-plus model)", "Praym-rayt modeli"],"ans":2,"exp":"To'g'ri javob: C) 'Xarajatlar plus' modeli (Cost-plus model)"},
            {"q":"'Praym-rayt' stavkasi qaysi muhim stavkalar o'zgarishiga asoslanadi?","opts":["Faqat inflyatsiya darajasiga", "Faqat LIBOR stavkasiga", "Faqat diskont stavkasiga", "Federal rezerv tizimining federal fondlar stavkasi va diskont stavkasiga"],"ans":3,"exp":"To'g'ri javob: B) Federal rezerv tizimining federal fondlar stavkasi va diskont stavkasiga"},
            {"q":"LIBOR stavkasining mazmuni nima?","opts":["London banklararo bozorida qisqa muddatli kreditlar bo'yicha etalon foiz stavkasi", "O'zbekiston banklararo kredit stavkasi", "Xalqaro valyuta fondi asosiy stavkasi", "AQSHning Federal rezerv tizimi stavkasi"],"ans":0,"exp":"To'g'ri javob: B) London banklararo bozorida qisqa muddatli kreditlar bo'yicha etalon foiz stavkasi"},
            {"q":"M.Fridmen qaysi ko'rsatkichdan monetar indikator sifatida foydalanishni taklif etdi?","opts":["M3", "Pul bazasi", "M1", "M2"],"ans":3,"exp":"To'g'ri javob: B) M2"},
            {"q":"Qaysi iqtisodchi olim inflyatsiya muammosini chuqur tadqiq etib Nobel mukofoti laureati bo'lgan?","opts":["M.Fridmen", "R.Mandel", "J.M.Keyns", "P.Samuelson"],"ans":0,"exp":"To'g'ri javob: C) M.Fridmen"},
            {"q":"Qaysi pul nazariyasida pulning tovar xususiyati inkor etiladi?","opts":["Marksistik pul nazariyasi", "Metall pul nazariyasi", "Nominal pul nazariyasi", "Miqdoriy pul nazariyasi"],"ans":2,"exp":"To'g'ri javob: C) Nominal pul nazariyasi"},
            {"q":"Qaysi pul nazariyasi merkantilizm g'oyasiga asoslanadi?","opts":["Keyns pul nazariyasi", "Metall pul nazariyasi", "Nominal pul nazariyasi", "Miqdoriy pul nazariyasi"],"ans":1,"exp":"To'g'ri javob: C) Metall pul nazariyasi"},
            {"q":"Kredit muomala vositasini ko'rsating:","opts":["Qog'oz pul (davlat)", "Oltin tanga", "Veksel, chek, banknot – kredit asosida kelib chiqqan to'lov vositalari", "Plastik debet karta"],"ans":2,"exp":"To'g'ri javob: B) Veksel, chek, banknot – kredit asosida kelib chiqqan to'lov vositalari"},
            {"q":"XVF ekspertlarining tavsiyasiga ko'ra monetizatsiya koeffitsientining minimal darajasi qancha bo'lishi kerak?","opts":["10%", "50%", "75%", "25%"],"ans":1,"exp":"To'g'ri javob: C) 50%"},
            {"q":"Senoraj nima?","opts":["Inflyatsiyani o'lchash koeffitsienti", "Markaziy bankning zararli operatsiyasi", "Davlatning pul emissiyasidan oladigan daromadi (pul chiqarish xarajatidan ortiq nominal qiymat)", "Tijorat bankining foiz daromadi"],"ans":2,"exp":"To'g'ri javob: B) Davlatning pul emissiyasidan oladigan daromadi (pul chiqarish xarajatidan ortiq nominal qiymat)"},
            {"q":"Emissiya qilingan naqd pullar Markaziy bank balansining qaysi qismida aks etadi?","opts":["Passivlar tomonida (majburiyat sifatida)", "Zahiralar qismida", "Kapital qismida", "Aktivlar tomonida"],"ans":0,"exp":"To'g'ri javob: B) Passivlar tomonida (majburiyat sifatida)"},
            {"q":"Markaziy bank tomonidan naqd pullar emissiya qilinganda uning balansida qanday o'zgarish sodir bo'ladi?","opts":["Faqat passivlar kamayadi", "Kapital oshadi", "Aktivlar (oltin, qimmatli qog'ozlar, valyuta) va passivlar (muomaladagi naqd pullar) bir vaqtda o...", "Faqat aktivlar oshadi"],"ans":2,"exp":"To'g'ri javob: B) Aktivlar (oltin, qimmatli qog'ozlar, valyuta) va passivlar (muomaladagi naqd pullar) bir vaqtda oshadi"},
            {"q":"To'lov topshiriqnomasiga xos bo'lgan kamchilik qaysi?","opts":["Tovarni olishdan avval pul to'lanadi, shuning uchun sotuvchi uchun qulay, lekin xaridor uchun old...", "Bank kafolati talab qilinadi", "Juda murakkab rasmiyatchilik", "Faqat katta summalar uchun ishlaydi"],"ans":0,"exp":"To'g'ri javob: B) Tovarni olishdan avval pul to'lanadi, shuning uchun sotuvchi uchun qulay, lekin xaridor uchun oldindan to'lov xavfi mavjud"},
            {"q":"Tijorat vekselini uchinchi shaxsga uzatgan sub'ekt kim deb ataladi?","opts":["Trассant", "Indossator (indossant) – vekselni boshqaga o'tkazuvchi shaxs", "Indossant", "Remitent"],"ans":1,"exp":"To'g'ri javob: B) Indossator (indossant) – vekselni boshqaga o'tkazuvchi shaxs"},
            {"q":"Naqdsiz pul aylanmasi nima?","opts":["Plastik kartalar orqali to'lovlar", "Pul mablag'larining bank hisobraqamlari orqali yozuvlar shaklida harakatlanishi", "Naqd pul harakati", "Faqat xalqaro to'lovlar"],"ans":1,"exp":"To'g'ri javob: B) Pul mablag'larining bank hisobraqamlari orqali yozuvlar shaklida harakatlanishi"},
            {"q":"Sof inkasso nima?","opts":["Tovar hujjatlarsiz faqat moliyaviy hujjatlar (veksel, chek) asosida amalga oshiriladigan inkasso", "Aktseptli inkasso", "Bank kafolati bilan ta'minlangan inkasso", "Tovar hujjatlari bilan birga amalga oshiriladigan inkasso"],"ans":0,"exp":"To'g'ri javob: A) Tovar hujjatlarsiz faqat moliyaviy hujjatlar (veksel, chek) asosida amalga oshiriladigan inkasso"},
            {"q":"O'zbekistonda hujjatlashtirilgan akkreditivlarning qaysi shaklidan keng foydalaniladi?","opts":["Standby akkreditiv", "Qaytarilmaydigan tasdiqlangan akkreditiv", "Transferabel akkreditiv", "Qaytariladigan akkreditiv"],"ans":1,"exp":"To'g'ri javob: B) Qaytarilmaydigan tasdiqlangan akkreditiv"},
            {"q":"Stend-bay akkreditiv birinchi bo'lib qaysi mamlakatning bank amaliyotida paydo bo'lgan?","opts":["Germaniyada", "Fransiyada", "Angliyada", "AQShda"],"ans":3,"exp":"To'g'ri javob: D) AQShda"},
            {"q":"Giperinflyatsiyada baholarning oylik o'sish sur'ati necha foizni tashkil etadi?","opts":["100 foizdan ortiq", "20 foizdan ortiq", "10 foizdan ortiq", "50 foizdan ortiq"],"ans":3,"exp":"To'g'ri javob: C) 50 foizdan ortiq"},
            {"q":"Talab inflyatsiyasida asosiy sabab nima?","opts":["Importning kamayishi", "Iqtisodiyotdagi umumiy talabning taklifdan oshib ketishi", "Soliqlarning oshishi", "Ishlab chiqarish xarajatlarining oshishi"],"ans":1,"exp":"To'g'ri javob: B) Iqtisodiyotdagi umumiy talabning taklifdan oshib ketishi"},
            {"q":"Inflyatsiyaning yillik darajasi necha foizdan oshmasa mo'tadil inflyatsiya hisoblanadi?","opts":["20%", "15%", "5%", "10%"],"ans":3,"exp":"To'g'ri javob: B) 10%"},
            {"q":"Quyidagi Markaziy banklardan qaysi biri inflyatsiyaning maqsadli ko'rsatkichidan monetar indikator sifatida foydalanadi?","opts":["Yaponiya Markaziy banki", "Bank of England (Angliya)", "Federal Rezerv tizimi (AQSh)", "Xitoy Xalq banki"],"ans":1,"exp":"To'g'ri javob: B) Bank of England (Angliya)"},
            {"q":"I.Fisherning xulosasiga ko'ra pul miqdori bilan narxlar o'rtasidagi bog'liqlik qanday?","opts":["Faqat qisqa muddatda bog'liqlik bor", "To'g'ridan-to'g'ri teskari bog'liqlik", "To'g'ridan-to'g'ri mutanosib bog'liqlik – pul miqdori oshsa, narxlar ham mutanosib oshadi", "Hech qanday bog'liqlik yo'q"],"ans":2,"exp":"To'g'ri javob: B) To'g'ridan-to'g'ri mutanosib bog'liqlik – pul miqdori oshsa, narxlar ham mutanosib oshadi"},
            {"q":"Tratta nima?","opts":["Akkreditiv shakli", "Bank cheki turi", "Oddiy veksel (solo veksel)", "Ko'chma veksel – trассant to'lovchiga (trassat) buyruq berish shaklida tuzilgan hujjat"],"ans":3,"exp":"To'g'ri javob: B) Ko'chma veksel – trассant to'lovchiga (trassat) buyruq berish shaklida tuzilgan hujjat"},
            {"q":"Vekselni indossament orqali qabul qilib olgan shaxs kim deb ataladi?","opts":["Indossator (indossant)", "Indossant", "Remitent", "Indossant"],"ans":0,"exp":"To'g'ri javob: B) Indossator (indossant)"},
            {"q":"Nima sababdan kumush tangalar muomaladan chiqib ketdi?","opts":["Kumush qimmatlashib ketgani uchun", "Davlat kumushni taqiqlagani uchun", "Kumush etishmovchiligi tufayli", "Greshem qonuniga ko'ra arzonroq kumush tangalar qimmatroq oltin tangalarni muomaladan siqib chiqardi"],"ans":3,"exp":"To'g'ri javob: B) Greshem qonuniga ko'ra arzonroq kumush tangalar qimmatroq oltin tangalarni muomaladan siqib chiqardi"},
            {"q":"Valyuta zaxiralarini diversifikatsiyalash nima?","opts":["Valyuta zaxiralarini turli valyutalar (dollar, evro, yuan va h.k.) va aktiv turlari o'rtasida taq...", "Zaxiralarni kamaytirish", "Barcha zaxirani dollarda saqlash", "Faqat oltin zaxirasini ko'paytirish"],"ans":0,"exp":"To'g'ri javob: B) Valyuta zaxiralarini turli valyutalar (dollar, evro, yuan va h.k.) va aktiv turlari o'rtasida taqsimlash"},
            {"q":"O'zbekiston Respublikasi Markaziy banki qaysi organ oldida hisobdor hisoblanadi?","opts":["Oliy Majlis (parlament) oldida", "Hukumat oldida", "Prezident oldida", "Moliya vazirligi oldida"],"ans":0,"exp":"To'g'ri javob: C) Oliy Majlis (parlament) oldida"},
            {"q":"Kreditga xos bo'lgan funktsiyani ko'rsating:","opts":["Valyuta kursini tartibga solish", "Qayta taqsimlash va muomala vositasini chiqarish funktsiyalari", "Soliq yig'ish", "Pul emissiyasi"],"ans":1,"exp":"To'g'ri javob: B) Qayta taqsimlash va muomala vositasini chiqarish funktsiyalari"},
            {"q":"Kreditning qaysi funktsiyasi orqali muomalada tijorat veksellari paydo bo'ladi?","opts":["Qayta taqsimlash funktsiyasi", "Nazorat funktsiyasi", "Pul aylanmasini iqtisad qilish va muomala vositasini chiqarish funktsiyasi", "Kapital to'plash funktsiyasi"],"ans":2,"exp":"To'g'ri javob: B) Pul aylanmasini iqtisad qilish va muomala vositasini chiqarish funktsiyasi"},
            {"q":"Sinditsiyali kredit nima?","opts":["Faqat bitta bank tomonidan beriladigan yirik kredit", "XVF tomonidan beriladigan kredit", "Bir necha bank birlashib (sindikat), yirik qarz oluvchiga birgalikda beradigan kredit", "Davlat kafolati ostida beriladigan imtiyozli kredit"],"ans":2,"exp":"To'g'ri javob: B) Bir necha bank birlashib (sindikat), yirik qarz oluvchiga birgalikda beradigan kredit"},
            {"q":"Tovar hujjatlarini regress huquqi bilan sotib olish qaysi kreditlash shakliga xos?","opts":["Forfeyting kreditiga", "Overdraft kreditiga", "Faktoring kreditiga", "Lombard kreditiga"],"ans":0,"exp":"To'g'ri javob: C) Forfeyting kreditiga"},
            {"q":"Kreditlash shakllaridan qaysi birida ssuda hisobraqami ochilmaydi?","opts":["Tijorat kreditida (veksel shaklida beriladi)", "Lombard kreditida", "Iste'mol kreditida", "Oddiy bank kreditida"],"ans":0,"exp":"To'g'ri javob: B) Tijorat kreditida (veksel shaklida beriladi)"},
            {"q":"Kreditlashning qaysi shaklida kredit olgan mijozning joriy hisobraqami yopiladi?","opts":["Sinditsiyali kreditda", "Oddiy kreditda", "Kontokorrent kreditida", "Overdraftda"],"ans":2,"exp":"To'g'ri javob: B) Kontokorrent kreditida"},
            {"q":"Quyidagi omillardan qaysi biri importni cheklaydi?","opts":["Eksport subsidiyalari", "Valyuta kursining tushishi (milliy valyuta qadrsizlanishi)", "Import bojlari va kvotalarining joriy qilinishi", "Ichki ishlab chiqarishning pasayishi"],"ans":2,"exp":"To'g'ri javob: B) Import bojlari va kvotalarining joriy qilinishi"},
            {"q":"Iqtisodiy adabiyotlarda pulning funktsiyalari bo'yicha qanday qarashlar mavjud?","opts":["Hammasi bir xil fikrda", "Faqat 2 ta funktsiya tan olinadi", "Faqat muomala va jamg'arish", "Turli maktablar turlicha talqin qiladi: marksistlar 5 funktsiya, G'arb iqtisodchilari asosan 3-4 ..."],"ans":3,"exp":"To'g'ri javob: B) Turli maktablar turlicha talqin qiladi: marksistlar 5 funktsiya, G'arb iqtisodchilari asosan 3-4 funktsiyani ajratadi"},
            {"q":"Oltinni demonetizatsiya qilish jarayoni qaysi jahon valyuta tizimida amalga oshirildi?","opts":["Yamayka valyuta tizimida", "Genuya valyuta tizimida", "Bretton-Vuds tizimida", "Parij valyuta tizimida"],"ans":0,"exp":"To'g'ri javob: D) Yamayka valyuta tizimida"},
            {"q":"Deflyatsiya nima?","opts":["Narxlarning umumiy darajasining pasayishi va pulning sotib olish qobiliyatining oshishi", "Iqtisodiy o'sishning to'xtashi", "Pul miqdorining haddan ziyod oshishi", "Narxlarning keskin ko'tarilishi"],"ans":0,"exp":"To'g'ri javob: C) Narxlarning umumiy darajasining pasayishi va pulning sotib olish qobiliyatining oshishi"},
            {"q":"Aktiv pullar nima?","opts":["Faqat kredit pullar", "Faqat naqd pullar", "Muomalada faol ishtirok etayotgan, tovar va xizmatlar harakatini xizmat qilayotgan pullar", "Bankdagi barcha pullar"],"ans":2,"exp":"To'g'ri javob: B) Muomalada faol ishtirok etayotgan, tovar va xizmatlar harakatini xizmat qilayotgan pullar"},
            {"q":"Aholining, korxonalarning va davlatning banklardagi hisob raqamlarida turgan pullar hamda aholining qo'lidagi naqd pullar bu:","opts":["M0", "M2", "M1", "M3"],"ans":2,"exp":"To'g'ri javob: B) M1"},
            {"q":"AQShda qanday pul agregatlari mavjud?","opts":["M0, M1, M2, M3", "M0, M1, M2", "Faqat M1 va M2", "M1, M2, M3, M4 (L)"],"ans":3,"exp":"To'g'ri javob: B) M1, M2, M3, M4 (L)"},
            {"q":"Milliy valyutaning pariteti nima?","opts":["Markaziy bank belgilaydigan kurs", "Milliy valyutaning bozor kursi", "Milliy valyutaning xorijiy valyutaga nisbatan rasmiy nisbati yoki oltin/SDR asosidagi qiymati", "Milliy valyutaning inflyatsiya darajasi"],"ans":2,"exp":"To'g'ri javob: B) Milliy valyutaning xorijiy valyutaga nisbatan rasmiy nisbati yoki oltin/SDR asosidagi qiymati"},
            {"q":"Pul tizimi qanday funktsiyalarni bajaradi?","opts":["Faqat valyuta kursini belgilash", "Pul muomalasini tartibga solish, hisob birligini belgilash, to'lov va jamg'arish mexanizmlarini t...", "Faqat kredit berish", "Faqat emissiya"],"ans":1,"exp":"To'g'ri javob: B) Pul muomalasini tartibga solish, hisob birligini belgilash, to'lov va jamg'arish mexanizmlarini ta'minlash"},
            {"q":"'Inflyatsiya' terminining tub mohiyati qanday ma'noni anglatadi?","opts":["Narxlar oshishi", "Pul qadrsizlanishi natijasida iqtisodiyotning 'shishishi' – muomaladagi pul miqdorining tovarlar ...", "Moliya inqirozi", "Valyuta kursi tushishi"],"ans":1,"exp":"To'g'ri javob: B) Pul qadrsizlanishi natijasida iqtisodiyotning 'shishishi' – muomaladagi pul miqdorining tovarlar taklifidan oshib ketishi"},
            {"q":"Agflyatsiya nima?","opts":["Qishloq xo'jaligi mahsulotlari narxining oshishi natijasida yuzaga keladigan inflyatsiya turi", "Sanoat mahsulotlari narxining oshishi", "Import narxlarining oshishi", "Xizmatlar narxining oshishi"],"ans":0,"exp":"To'g'ri javob: B) Qishloq xo'jaligi mahsulotlari narxining oshishi natijasida yuzaga keladigan inflyatsiya turi"},
            {"q":"Yashirin inflyatsiya nima?","opts":["Oshkora narx oshishi", "Faqat oziq-ovqat narxlari oshishi", "Import inflyatsiyasi", "Narxlar rasman oshmaydigan, lekin tovar taqchilligi, sifat pasayishi va 'kulrang bozor' ko'rinish..."],"ans":3,"exp":"To'g'ri javob: A) Narxlar rasman oshmaydigan, lekin tovar taqchilligi, sifat pasayishi va 'kulrang bozor' ko'rinishidagi yashirin inflyatsiya"},
            {"q":"Stagnatsiyaning asosiy belgilari nimalarda namoyon bo'ladi?","opts":["Yuqori iqtisodiy o'sish va yuqori inflyatsiya", "Iqtisodiy o'sish va past inflyatsiya", "Faqat eksportning kamayishi", "Iqtisodiy o'sishning sekinlashishi yoki to'xtashi, ishsizlikning oshishi va past ishlab chiqarish..."],"ans":3,"exp":"To'g'ri javob: B) Iqtisodiy o'sishning sekinlashishi yoki to'xtashi, ishsizlikning oshishi va past ishlab chiqarish sur'atlari"},
            {"q":"Kreditning ob'ektiv zarurligini belgilovchi omil qaysi?","opts":["Iqtisodiy sub'ektlarning vaqtincha bo'sh mablag'lari va vaqtincha qo'shimcha mablag'larga ehtiyoj...", "Davlat talabi", "Bank manfaati", "Xalqaro standartlar"],"ans":0,"exp":"To'g'ri javob: B) Iqtisodiy sub'ektlarning vaqtincha bo'sh mablag'lari va vaqtincha qo'shimcha mablag'larga ehtiyoj mavjudligi"},
            {"q":"Tijorat kreditining maqsadi nima?","opts":["Qurilish loyihalarini moliyalashtirish", "Korxonalar o'rtasida tovar aylanmasini tezlashtirish va ishlab chiqarish jarayonini uzluksiz ta'm...", "Davlat byudjetini to'ldirish", "Iste'mol uchun tovar sotib olish"],"ans":1,"exp":"To'g'ri javob: B) Korxonalar o'rtasida tovar aylanmasini tezlashtirish va ishlab chiqarish jarayonini uzluksiz ta'minlash"},
            {"q":"Lombard krediti nima?","opts":["Davlat kafolati asosida beriladigan kredit", "Faqat korxonalarga beriladigan investitsiya krediti", "Garovsiz beriladigan uzoq muddatli kredit", "Qimmatbaho buyumlar, qimmatli qog'ozlar yoki boshqa likvid garov ostida beriladigan qisqa muddatl..."],"ans":3,"exp":"To'g'ri javob: B) Qimmatbaho buyumlar, qimmatli qog'ozlar yoki boshqa likvid garov ostida beriladigan qisqa muddatli kredit"},
            {"q":"Kredit portfeli nima?","opts":["Bankning qimmatli qog'ozlari", "Bankning depozitlari yig'indisi", "Bank tomonidan berilgan barcha kreditlar va ularning holati haqidagi ma'lumotlar majmui", "Bankning kassasidagi naqd pullar"],"ans":2,"exp":"To'g'ri javob: B) Bank tomonidan berilgan barcha kreditlar va ularning holati haqidagi ma'lumotlar majmui"},
            {"q":"Bank aksepti nima?","opts":["Bank tomonidan beriladigan garov", "Depozit sertifikati turi", "Bankning kredit berish roziligi", "Bank tomonidan to'lov kafolatini bildiruvchi qabul belgisi qo'yilgan veksel"],"ans":3,"exp":"To'g'ri javob: B) Bank tomonidan to'lov kafolatini bildiruvchi qabul belgisi qo'yilgan veksel"},
            {"q":"Obligatsiya nima?","opts":["Aksiyadorlik hujjati", "Xalqaro kredit hujjati", "Bank depozit sertifikati", "Emitentning egaliga belgilangan foiz to'lab, muddati tugagach asosiy summani qaytarish majburiyat..."],"ans":3,"exp":"To'g'ri javob: B) Emitentning egaliga belgilangan foiz to'lab, muddati tugagach asosiy summani qaytarish majburiyatini ifodalovchi qimmatli qog'oz"},
            {"q":"Barter nima? (takrorlash)","opts":["Kredit asosida tovar olish", "Leasing shartnomasi", "Tovarlarni pulsiz, to'g'ridan-to'g'ri boshqa tovar bilan ayirboshlash", "Tovarni pulga sotish"],"ans":2,"exp":"To'g'ri javob: B) Tovarlarni pulsiz, to'g'ridan-to'g'ri boshqa tovar bilan ayirboshlash"},
            {"q":"Inflyatsiya bilan bog'liq muammolar qachon vujudga kelgan?","opts":["Faqat I Jahon urushidan keyin", "Faqat XX asrda", "Qog'oz pul muomalasi paydo bo'lishi bilan – XVII-XVIII asrlardan boshlab", "Faqat 1970-yillardan keyin"],"ans":2,"exp":"To'g'ri javob: B) Qog'oz pul muomalasi paydo bo'lishi bilan – XVII-XVIII asrlardan boshlab"},
            {"q":"Naqd pullar nima?","opts":["Faqat banknot", "Faqat metallik tangalar", "Muomaladagi qog'oz pullar va tangalar – moddiy shakldagi pul belgilari", "Faqat qog'oz pullar"],"ans":2,"exp":"To'g'ri javob: B) Muomaladagi qog'oz pullar va tangalar – moddiy shakldagi pul belgilari"},
            {"q":"Bank ekvayer deganda nimani tushunasiz?","opts":["Savdogar (do'kon, korxona) nomidan plastik kartochka bo'yicha to'lovlarni qabul qiluvchi bank", "Plastik kartochka chiqaruvchi bank", "Kredit bürosi", "Faqat debet karta beruvchi bank"],"ans":0,"exp":"To'g'ri javob: B) Savdogar (do'kon, korxona) nomidan plastik kartochka bo'yicha to'lovlarni qabul qiluvchi bank"},
            {"q":"Plastik kartochkalar aloqadorligi bo'yicha qanday turlarga bo'linadi?","opts":["Lokal, milliy va xalqaro (VISA, MasterCard va b.)", "Faqat milliy va xalqaro", "Faqat debet va kredit", "Faqat lokal va xalqaro"],"ans":0,"exp":"To'g'ri javob: B) Lokal, milliy va xalqaro (VISA, MasterCard va b.)"},
            {"q":"To'lov aylanmasi nima?","opts":["Muayyan davr mobaynida barcha to'lovlar majmui – naqd va naqdsiz to'lovlar yig'indisi", "Faqat xalqaro to'lovlar", "Faqat bank operatsiyalari", "Faqat naqd pul harakati"],"ans":0,"exp":"To'g'ri javob: B) Muayyan davr mobaynida barcha to'lovlar majmui – naqd va naqdsiz to'lovlar yig'indisi"},
            {"q":"O'zbekistonda qanday pul agregatlari amal qiladi?","opts":["M1 va M2", "Faqat M0", "M0, M1 va M2", "M0, M1, M2 va M3"],"ans":3,"exp":"To'g'ri javob: C) M0, M1, M2 va M3"},
            {"q":"Mamlakatda pul tizimining asosini nima tashkil etadi?","opts":["Tijorat banklari", "Davlat byudjeti", "Xalqaro valyuta zahiralari", "Milliy valyuta va uni tartibga soluvchi qonunchilik"],"ans":3,"exp":"To'g'ri javob: B) Milliy valyuta va uni tartibga soluvchi qonunchilik"},
            {"q":"Inkasso topshiriqnomasini kimlar taqdim etishi to'g'ri keltirilgan qator qaysi?","opts":["Faqat tijorat banklari", "Faqat jismoniy shaxslar", "Faqat Markaziy bank", "Soliq organlari, sudlar, bojxona qo'mitasi, notariuslar, majburiy ijro byurosi"],"ans":3,"exp":"To'g'ri javob: B) Soliq organlari, sudlar, bojxona qo'mitasi, notariuslar, majburiy ijro byurosi"},
            {"q":"Uzoq muddatli kredit qanday muddatga beriladi?","opts":["1 yildan kam", "3 yildan 5 yilgacha", "1 yildan 3 yilgacha", "5 yildan ortiq"],"ans":3,"exp":"To'g'ri javob: D) 5 yildan ortiq"},
            {"q":"Kreditning sub'ektlarini ko'rsating:","opts":["Faqat banklar", "Faqat yuridik shaxslar", "Faqat davlat muassasalari", "Kreditor (qarz beruvchi) va qarz oluvchi"],"ans":3,"exp":"To'g'ri javob: B) Kreditor (qarz beruvchi) va qarz oluvchi"},
            {"q":"Quyidagi qaysi mamlakatlarning pul birligining nomi dollar?","opts":["Faqat AQSh va Kanada", "Faqat ingliz tilida so'zlashuvchi mamlakatlar", "Faqat AQSh", "AQSh, Kanada, Avstraliya, Yangi Zelandiya, Singapur va boshqa bir qancha mamlakatlar"],"ans":3,"exp":"To'g'ri javob: B) AQSh, Kanada, Avstraliya, Yangi Zelandiya, Singapur va boshqa bir qancha mamlakatlar"},
            {"q":"Mol yetkazib beruvchi uchun mablag'ni kafolatlaydigan hisob-kitob shakli qaysi?","opts":["Inkasso", "To'lov topshiriqnomasi", "To'lov talabnomasi", "Akkreditiv"],"ans":3,"exp":"To'g'ri javob: B) Akkreditiv"},
            {"q":"To'lov talabnomaning akseptli shaklida qanday tartib qo'llaniladi?","opts":["To'lovchi hujjatlarni ko'rib chiqib, rozilik (aktsept) berganidan keyingina to'lov amalga oshiriladi", "To'lov avtomatik amalga oshiriladi", "Markaziy bank ruxsati kerak", "Sud qarorisiz to'lov amalga oshiriladi"],"ans":0,"exp":"To'g'ri javob: B) To'lovchi hujjatlarni ko'rib chiqib, rozilik (aktsept) berganidan keyingina to'lov amalga oshiriladi"},
            {"q":"Oltin davlatlar o'rtasida yagona pul (jahon puli) sifatida qachon va qayerda qabul qilingan?","opts":["1816-yil Londonda", "1944-yil Bretton-Vudsda", "1922-yil Genuyada", "1867-yil Parijda"],"ans":3,"exp":"To'g'ri javob: B) 1867-yil Parijda"},
            {"q":"Xalqaro amaliyotda tijorat krediti asosan qanday qimmatli qog'oz vositasida beriladi?","opts":["Sertifikat orqali", "Aksiya orqali", "Obligatsiya orqali", "Veksel (tratta) orqali"],"ans":3,"exp":"To'g'ri javob: B) Veksel (tratta) orqali"},
            {"q":"Xitoy xalq respublikasining pul birligi nima?","opts":["Yen", "Von", "Dong", "Yuan (Renminbi)"],"ans":3,"exp":"To'g'ri javob: C) Yuan (Renminbi)"},
            {"q":"Yevropa valyuta ittifoqiga a'zo bo'lish shartlarida davlat qarzi YaIMning necha foizini tashkil etishi kerak?","opts":["80 foizdan oshmasligi", "60 foizdan oshmasligi (Maastrix mezoni)", "100 foizdan oshmasligi", "30 foizdan oshmasligi"],"ans":1,"exp":"To'g'ri javob: B) 60 foizdan oshmasligi (Maastrix mezoni)"},
            {"q":"Kreditning nechta tamoyili mavjud?","opts":["6 ta", "5 ta", "4 ta", "3 ta"],"ans":1,"exp":"To'g'ri javob: C) 5 ta"},
            {"q":"AQShda qancha muddatga berilgan kreditlar o'rta muddatli hisoblanadi?","opts":["1 yildan 5 yilgacha", "3 yildan 7 yilgacha", "5 yildan 10 yilgacha", "1 yildan 3 yilgacha"],"ans":0,"exp":"To'g'ri javob: B) 1 yildan 5 yilgacha"},
            {"q":"Kreditlar ta'minlanganlik darajasiga ko'ra nechta turga bo'linadi?","opts":["Besh turga", "To'rt turga", "Ikki turga: ta'minlangan va ta'minlanmagan", "Uch turga"],"ans":2,"exp":"To'g'ri javob: A) Ikki turga: ta'minlangan va ta'minlanmagan"},
            {"q":"Kreditlar bahosiga ko'ra qanday turlarga bo'linadi?","opts":["Bozor foizli, imtiyozli (past foizli) va yuqori foizli kreditlar", "Qisqa va uzoq muddatli", "Qimmat va arzon", "Faqat foizli va foizsiz"],"ans":0,"exp":"To'g'ri javob: B) Bozor foizli, imtiyozli (past foizli) va yuqori foizli kreditlar"},
            {"q":"Kredit qanday ko'rinishda beriladi?","opts":["Faqat naqd pul shaklida", "Faqat veksel shaklida", "Faqat naqdsiz shaklda", "Pul shaklida va tovar shaklida"],"ans":3,"exp":"To'g'ri javob: B) Pul shaklida va tovar shaklida"},
            {"q":"Chek nima?","opts":["Bank hisobraqamidan pul to'lash to'g'risida buyruq beruvchi hujjat", "Tijorat vekseli turi", "Bank muddatli depoziti", "Davlat qarz majburiyati"],"ans":0,"exp":"To'g'ri javob: B) Bank hisobraqamidan pul to'lash to'g'risida buyruq beruvchi hujjat"},
            {"q":"Kredit qanday munosabatlar asosida tashkil topadi?","opts":["Qaytarish, muddatlilik va to'lovlilik shartlari asosida vaqtincha foydalanishga berilgan qiymat h...", "Davlat majburlovi asosida", "Barter munosabatlari", "Sovg'a munosabatlari"],"ans":0,"exp":"To'g'ri javob: B) Qaytarish, muddatlilik va to'lovlilik shartlari asosida vaqtincha foydalanishga berilgan qiymat harakati munosabatlari"},
            {"q":"Ilk paydo bo'lgan kredit shakli qaysi?","opts":["Tijorat krediti", "Iste'mol krediti", "Bank krediti", "Sudxo'rlik krediti"],"ans":3,"exp":"To'g'ri javob: C) Sudxo'rlik krediti"},
            {"q":"Kredit so'zining ma'nosi nimani anglatadi?","opts":["Pul (lotin)", "Garov (frantsuz)", "Ishonmoq, qarz bermoq (lotin: credere)", "Foiz (ingliz)"],"ans":2,"exp":"To'g'ri javob: B) Ishonmoq, qarz bermoq (lotin: credere)"},
            {"q":"Iste'mol kreditining necha shakli bor?","opts":["Besh shakl", "To'rt shakl", "Uch shakl", "Ikki shakl"],"ans":2,"exp":"To'g'ri javob: B) Uch shakl"},
            {"q":"Iste'mol krediti ob'ekti nima hisoblanadi?","opts":["Ishlab chiqarish uskunalari", "Aholi tomonidan shaxsiy iste'mol maqsadida sotib olinadigan tovarlar va xizmatlar", "Korxona aylanma mablag'lari", "Qimmatli qog'ozlar"],"ans":1,"exp":"To'g'ri javob: B) Aholi tomonidan shaxsiy iste'mol maqsadida sotib olinadigan tovarlar va xizmatlar"},
            {"q":"Pulning qaysi funktsiyasida tovarlar summasi muddatini kechiktirib to'lanadi?","opts":["To'lov vositasi", "Muomala vositasi", "Jamg'arish vositasi", "Qiymat o'lchovi"],"ans":0,"exp":"To'g'ri javob: C) To'lov vositasi"},
            {"q":"Pulning kelib chiqishi to'g'risida qanday g'oyalar mavjud bo'lgan?","opts":["Faqat ixtiro nazariyasi", "Ratsionalistik (davlat bitimi natijasi) va evolyutsion (tovar aylanmasi jarayonida tabiiy paydo b...", "Faqat evolyutsion g'oya", "Faqat bitta – tovar g'oyasi"],"ans":1,"exp":"To'g'ri javob: B) Ratsionalistik (davlat bitimi natijasi) va evolyutsion (tovar aylanmasi jarayonida tabiiy paydo bo'lish) g'oyalari"},
            {"q":"Amaliyotda plastik kartochkalardan birinchi bo'lib foydalanila boshlagan davlat qaysi?","opts":["AQSh (1950-yillarda Diners Club)", "Germaniya", "Angliya", "Yaponiya"],"ans":0,"exp":"To'g'ri javob: C) AQSh (1950-yillarda Diners Club)"},
            {"q":"Topshiriqnomaning sanasiga qanday talab qo'yiladi?","opts":["Faqat oyning 1-15 kunlari bo'lishi mumkin", "Topshiriqnoma tuzilgan haqiqiy sana ko'rsatilishi shart", "Har qanday sana bo'lishi mumkin", "Sana ixtiyoriy"],"ans":1,"exp":"To'g'ri javob: B) Topshiriqnoma tuzilgan haqiqiy sana ko'rsatilishi shart"},
            {"q":"Pulning aylanish tezligi qaysi formula orqali aniqlanadi?","opts":["V = M × P", "V = P × T", "V = M / YaIM", "V = YaIM / M (nominal YaIM pul massasiga bo'linadi)"],"ans":3,"exp":"To'g'ri javob: B) V = YaIM / M (nominal YaIM pul massasiga bo'linadi)"},
            {"q":"Iste'mol krediti kimlarga berilishi mumkin?","opts":["Faqat davlat xodimlariga", "Jismoniy shaxslarga (aholiga) shaxsiy iste'mol ehtiyojlari uchun", "Faqat tadbirkorlarga", "Faqat yuridik shaxslarga"],"ans":1,"exp":"To'g'ri javob: B) Jismoniy shaxslarga (aholiga) shaxsiy iste'mol ehtiyojlari uchun"},
            {"q":"Vekselning qanday turlari mavjud?","opts":["Uch tur: oddiy, ko'chma va bank vekseli", "To'rt tur", "Faqat bir tur", "Oddiy veksel (solo) va ko'chma veksel (tratta)"],"ans":3,"exp":"To'g'ri javob: B) Oddiy veksel (solo) va ko'chma veksel (tratta)"},
            {"q":"Kredit foizlari foizlarni hisoblash usuliga ko'ra nechta turga bo'linadi?","opts":["To'rt turga", "Uch turga", "Besh turga", "Ikki turga: oddiy va murakkab"],"ans":3,"exp":"To'g'ri javob: A) Ikki turga: oddiy va murakkab"},
            {"q":"Kredit foizlari to'lash shakliga ko'ra nechta turga bo'linadi?","opts":["Besh turga", "Ikki turga: oldindan va muddati tugagach to'lanadigan", "Uch turga", "To'rt turga"],"ans":1,"exp":"To'g'ri javob: A) Ikki turga: oldindan va muddati tugagach to'lanadigan"},
            {"q":"Kredit foizlari o'zgarishi bo'yicha nechta turga bo'linadi?","opts":["Uch turga", "Ikki turga: qat'iy (fixed) va o'zgaruvchan (floating)", "Besh turga", "To'rt turga"],"ans":1,"exp":"To'g'ri javob: A) Ikki turga: qat'iy (fixed) va o'zgaruvchan (floating)"},
            {"q":"O'zbekiston bank amaliyotida kredit foizlarni hisoblash shaklining qanday usullaridan foydalaniladi?","opts":["Faqat anuitet usuli", "Oddiy foiz va anuitет usullari", "Faqat oddiy foiz usuli", "Faqat murakkab foiz usuli"],"ans":1,"exp":"To'g'ri javob: B) Oddiy foiz va anuitет usullari"},
            {"q":"Kredit foizlariga ta'sir qiluvchi tashqi omillar qaysilar?","opts":["Markaziy bankning pul-kredit siyosati, inflyatsiya darajasi, pul bozoridagi talab va taklif, iqti...", "Kredit maqsadi va ta'minoti sifati", "Bankning jalb qilingan resurslari bahosi", "Mijozning kredit tarixi"],"ans":0,"exp":"To'g'ri javob: B) Markaziy bankning pul-kredit siyosati, inflyatsiya darajasi, pul bozoridagi talab va taklif, iqtisodiy holat"},
            {"q":"Kredit foizlariga ta'sir qiluvchi ichki omillar qaysilar?","opts":["Bankning jalb qilingan resurslari bahosi, mijozning kredit tarixi, kredit maqsadi va ta'minoti si...", "Pul bozoridagi talab va taklif", "Inflyatsiya va bandlik darajasi", "Markaziy bankning pul-kredit siyosati"],"ans":0,"exp":"To'g'ri javob: B) Bankning jalb qilingan resurslari bahosi, mijozning kredit tarixi, kredit maqsadi va ta'minoti sifati, kredit muddati"},
            {"q":"Kredit shartnomasi bajarilgunga qadar o'zgarmasdan qoluvchi foiz stavkasi bu:","opts":["O'zgaruvchan (floating) foiz stavkasi", "Diskont stavkasi", "Qat'iy (fixed) foiz stavkasi", "Bozor foiz stavkasi"],"ans":2,"exp":"To'g'ri javob: B) Qat'iy (fixed) foiz stavkasi"},
            {"q":"Kredit shartnomasi muddati tugagunga qadar o'zgarmasdan qoluvchi foiz stavkasi bu:","opts":["O'zgaruvchan foiz stavkasi", "LIBOR stavkasi", "Qat'iy (fixed) foiz stavkasi", "Praym-rayt stavkasi"],"ans":2,"exp":"To'g'ri javob: B) Qat'iy (fixed) foiz stavkasi"},
            {"q":"Markaziy bank yoki pul bozori stavkasi o'zgarishi natijasida kredit foiz stavkasi ham o'zgarishini nazarda tutuvchi stavka bu:","opts":["O'zgaruvchan (floating) foiz stavkasi", "Nominal foiz stavkasi", "Qat'iy (fixed) foiz stavkasi", "Diskont stavkasi"],"ans":0,"exp":"To'g'ri javob: B) O'zgaruvchan (floating) foiz stavkasi"},
            {"q":"Banklar tomonidan ajratilgan kreditning foizlari oldindan undirib olish orqali kreditlash bu:","opts":["Diskontlash usuli (diskont kredit)", "Murakkab foiz usuli", "Anuitet usuli", "Oddiy foiz usuli"],"ans":0,"exp":"To'g'ri javob: B) Diskontlash usuli (diskont kredit)"},
            {"q":"Tijorat banklari riskli aktiv operatsiyalari natijasida nima sodir bo'lishi mumkin?","opts":["Zarar ko'rishi, kapital yetarliligining pasayishi va to'lovga layoqatsizlik", "Daromadlar oshishi garantlangan", "Foiz daromadlari oshishi", "Yangi depozitlar jalb qilinishi"],"ans":0,"exp":"To'g'ri javob: B) Zarar ko'rishi, kapital yetarliligining pasayishi va to'lovga layoqatsizlik"},
            {"q":"Markaziy bankning pul-kredit siyosati usullari qaysi javobda noto'g'ri keltirilgan?","opts":["Soliq stavkasini belgilash", "Diskont (qayta moliyalashtirish) stavkasi", "Ochiq bozor operatsiyalari", "Majburiy rezervlar normasi"],"ans":0,"exp":"To'g'ri javob: D) Soliq stavkasini belgilash"},
            {"q":"Banklarning noan'anaviy operatsiyalari qanday javobda to'liq keltirilgan?","opts":["Lizing, faktoring, forfeyting, traст, konsalting va kafolat operatsiyalari", "Kredit va depozit operatsiyalari", "Faqat qimmatli qog'ozlar operatsiyalari", "Faqat valyuta operatsiyalari"],"ans":0,"exp":"To'g'ri javob: B) Lizing, faktoring, forfeyting, traст, konsalting va kafolat operatsiyalari"},
            {"q":"Tijorat banklari bir emitent chiqargan qimmatli qog'ozlarni birinchi darajali kapitalning necha foizigacha sotib olishi mumkin?","opts":["25 foizgacha", "10 foizgacha", "15 foizgacha", "5 foizgacha"],"ans":2,"exp":"To'g'ri javob: C) 15 foizgacha"},
            {"q":"Tijorat banklari quyidagi qaysi operatsiyalarni bajarishi mumkin?","opts":["Savdo faoliyati", "Sug'urta faoliyati", "Depozit qabul qilish, kredit berish, hisob-kitob operatsiyalari va valyuta operatsiyalari", "Ishlab chiqarish faoliyati"],"ans":2,"exp":"To'g'ri javob: B) Depozit qabul qilish, kredit berish, hisob-kitob operatsiyalari va valyuta operatsiyalari"},
            {"q":"Tijorat banklari quyida berilgan qaysi faoliyat turlari bilan shug'ullanmaydi?","opts":["Valyuta operatsiyalari", "Kredit berish", "Depozit qabul qilish", "Sug'urta, ishlab chiqarish va savdo faoliyati"],"ans":3,"exp":"To'g'ri javob: B) Sug'urta, ishlab chiqarish va savdo faoliyati"},
            {"q":"Taftish komissiyasi faoliyati kimning manfaatlariga qaratilgan?","opts":["Aksiyadorlar va omonatchilar manfaatlarini himoya qilishga", "Bank boshqaruvining", "Faqat Markaziy bankning", "Faqat hukumatning"],"ans":0,"exp":"To'g'ri javob: B) Aksiyadorlar va omonatchilar manfaatlarini himoya qilishga"},
            {"q":"Ma'lum bir bank mahsulotini yaratish maqsadida amalga oshirilgan harakatlar majmui nima deyiladi?","opts":["Bank xizmati", "Bank mahsuloti", "Bank operatsiyasi", "Bank texnologiyasi"],"ans":3,"exp":"To'g'ri javob: C) Bank texnologiyasi"},
            {"q":"Imtiyozli aksiyador qanday masala yuzasidan umumiy yig'ilishda ovoz berish huquqiga ega?","opts":["Faqat bankni tugatish yoki qayta tashkil etish masalalarida", "Barcha masalalar bo'yicha", "Hech qachon ovoz bermaydi", "Faqat dividend masalalari bo'yicha"],"ans":0,"exp":"To'g'ri javob: B) Faqat bankni tugatish yoki qayta tashkil etish masalalarida"},
            {"q":"O'zbekiston Markaziy banki nima qilishga haqli emas?","opts":["Tijorat banklari faoliyatini nazorat qilish", "Valyuta interventsiyasi o'tkazish", "Pul emissiyasi qilish", "Tijorat faoliyati bilan shug'ullanish"],"ans":3,"exp":"To'g'ri javob: C) Tijorat faoliyati bilan shug'ullanish"},
            {"q":"O'zbekiston Markaziy bankiga quyidagi qaysi operatsiya taqiqlangan?","opts":["Valyuta kursini belgilash", "Tovar-moddiy boyliklarni sotib olish va savdo faoliyati", "Tijorat banklarini kreditlash", "Majburiy rezerv normalarini o'rnatish"],"ans":1,"exp":"To'g'ri javob: B) Tovar-moddiy boyliklarni sotib olish va savdo faoliyati"},
            {"q":"O'zbekiston Markaziy banki uchun taqiqlangan faoliyat turini belgilang:","opts":["Diskont stavkasini belgilash", "Pul emissiyasi", "Tovar ishlab chiqarish, xizmat ko'rsatish va savdo faoliyati", "Bank litsenziyalarini berish"],"ans":2,"exp":"To'g'ri javob: B) Tovar ishlab chiqarish, xizmat ko'rsatish va savdo faoliyati"},
            {"q":"O'zbekiston Markaziy bankiga quyidagi operatsiyalardan qaysi biriga nisbatan cheklov mavjud?","opts":["Bir tijorat bankiga bir vaqtda uzoq muddatli kredit berish", "Valyuta rezervlarini boshqarish", "Tijorat banklarini kreditlash", "Diskont siyosati"],"ans":0,"exp":"To'g'ri javob: B) Bir tijorat bankiga bir vaqtda uzoq muddatli kredit berish"},
            {"q":"Berilgan operatsiyalardan qaysi biri uchun O'zbekiston Markaziy bankiga nisbatan taqiq mavjud?","opts":["Valyuta interventsiyasi o'tkazish", "Davlat qimmatli qog'ozlarini ikkilamchi bozorda sotib olish", "Tijorat banklari aksiyalarini sotib olish", "Refinansirlash stavkasini belgilash"],"ans":2,"exp":"To'g'ri javob: B) Tijorat banklari aksiyalarini sotib olish"},
            {"q":"Lombard krediti bu: (takrorlash)","opts":["Uzoq muddatli ipoteka krediti", "Qimmatbaho buyumlar yoki likvid garov ostida beriladigan qisqa muddatli kredit", "Davlat subsidiya krediti", "Garovsiz beriladigan kredit"],"ans":1,"exp":"To'g'ri javob: B) Qimmatbaho buyumlar yoki likvid garov ostida beriladigan qisqa muddatli kredit"},
            {"q":"Banklar qachondan boshlab yuridik shaxs maqomiga ega bo'ladi?","opts":["Faoliyat boshlagandan", "Birinchi operatsiya qilingan kundan", "Davlat ro'yxatidan o'tgan kundan", "Litsenziya olgan kundan"],"ans":2,"exp":"To'g'ri javob: B) Davlat ro'yxatidan o'tgan kundan"},
            {"q":"Banklar qanday hollarda o'z faoliyatini to'xtatadi?","opts":["Litsenziyasi bekor qilinganida, qayta tashkil etilganida yoki tugatilganida", "Faqat o'z ixtiyori bilan", "Faqat Markaziy bank buyrug'i bilan", "Faqat bankrot bo'lganda"],"ans":0,"exp":"To'g'ri javob: B) Litsenziyasi bekor qilinganida, qayta tashkil etilganida yoki tugatilganida"},
            {"q":"O'zbekistonda muammoli aktivlar (NPL) ga qaysilar kiradi?","opts":["Substandart, shubhali va umidsiz toifadagi kreditlar", "Barcha muddati o'tgan kreditlar", "Faqat umidsiz kreditlar", "Faqat to'lanmagan kreditlar"],"ans":0,"exp":"To'g'ri javob: B) Substandart, shubhali va umidsiz toifadagi kreditlar"},
            {"q":"O'zbekistonda aktivlar likvidliligiga ko'ra qanday tasniflanadi?","opts":["Uch turga bo'linadi", "Faqat qisqa va uzoq muddatli", "Yuqori likvid, likvid, kam likvid va nolikvid aktivlar", "Faqat likvid va nolikvid"],"ans":2,"exp":"To'g'ri javob: B) Yuqori likvid, likvid, kam likvid va nolikvid aktivlar"},
            {"q":"I darajali kapital regulyativ kapitalni qancha foizidan kam bo'lmasligi lozim?","opts":["60 foiz", "40 foiz", "50 foiz", "75 foiz"],"ans":0,"exp":"To'g'ri javob: C) 60 foiz"},
            {"q":"X asrda dastlabki banklar Italiyaning qaysi shaharlarida paydo bo'lgan?","opts":["Boloniya va Verona", "Milan va Turin", "Genuya, Venetsiya va Florensiya", "Rim va Napoli"],"ans":2,"exp":"To'g'ri javob: C) Genuya, Venetsiya va Florensiya"},
            {"q":"Banklarning ibodatxonalarda rivojlanib ketishiga to'siq bo'lgan asosiy sabab qaysi?","opts":["Ibodatxonalar kichik bo'lgan", "Davlat taqiqlagan", "Ibodatxonalarda pul yo'q edi", "Cherkov foiz olishni 'ribo' sifatida taqiqlagan diniy qoidalar"],"ans":3,"exp":"To'g'ri javob: B) Cherkov foiz olishni 'ribo' sifatida taqiqlagan diniy qoidalar"},
            {"q":"Bank passiv operatsiyalari deganda nimani tushunasiz?","opts":["Qimmatli qog'ozlar bilan operatsiyalar", "Valyuta operatsiyalari", "Bankning kredit berish operatsiyalari", "Bankning resurslarini jalb qilish va kapitalini shakllantirish operatsiyalari"],"ans":3,"exp":"To'g'ri javob: B) Bankning resurslarini jalb qilish va kapitalini shakllantirish operatsiyalari"},
            {"q":"100% rezerv qaysi kreditlar uchun ajratiladi?","opts":["Umidsiz (to'lanishi imkonsiz) toifadagi kreditlar uchun", "Standart kreditlar uchun", "Substandart kreditlar uchun", "Shubhali kreditlar uchun"],"ans":0,"exp":"To'g'ri javob: B) Umidsiz (to'lanishi imkonsiz) toifadagi kreditlar uchun"},
            {"q":"Bank korporativ boshqarish tizimiga quyidagilardan qaysilar kiradi?","opts":["Faqat taftish komissiyasi", "Faqat aktsiyadorlar", "Aktsiyadorlar umumiy yig'ilishi, kuzatuv kengashi, boshqaruv va taftish komissiyasi", "Faqat boshqaruv kengashi"],"ans":2,"exp":"To'g'ri javob: B) Aktsiyadorlar umumiy yig'ilishi, kuzatuv kengashi, boshqaruv va taftish komissiyasi"},
            {"q":"Tijorat banklari uchun majburiy rezervlar normasini kim o'rnatadi?","opts":["Markaziy bank", "Tijorat banklari assotsiatsiyasi", "Hukumat", "Moliya vazirligi"],"ans":0,"exp":"To'g'ri javob: B) Markaziy bank"},
            {"q":"'O'zbekiston Respublikasi Markaziy banki to'g'risida'gi qonunning yangi tahriri qachon qabul qilingan?","opts":["2019-yil", "2021-yil", "2020-yil", "2022-yil"],"ans":1,"exp":"To'g'ri javob: C) 2021-yil"},
            {"q":"'Bank' so'zining ma'nosi nima?","opts":["Pul saqlash joyi (arabcha)", "Kredit tashkiloti (frantsuzcha)", "Moliya muassasasi (inglizcha)", "Sandiq, stol (italyancha: banco – sarroflar stoli)"],"ans":3,"exp":"To'g'ri javob: B) Sandiq, stol (italyancha: banco – sarroflar stoli)"},
            {"q":"Aktivlar sifatiga ko'ra qanday tasniflanadi?","opts":["Faqat likvid va nolikvid", "Faqat yaxshi va yomon", "Uch toifaga", "Standart, substandart, shubhali va umidsiz toifalar"],"ans":3,"exp":"To'g'ri javob: B) Standart, substandart, shubhali va umidsiz toifalar"},
            {"q":"Bank kengashi a'zolari soni kamida necha kishidan iborat bo'lishi kerak?","opts":["3 kishi", "5 kishi", "9 kishi", "7 kishi"],"ans":1,"exp":"To'g'ri javob: B) 5 kishi"},
            {"q":"Banklarni litsenziyalash jarayoni necha bosqichdan iborat?","opts":["Ikki bosqich", "Besh bosqich", "To'rt bosqich", "Uch bosqich"],"ans":3,"exp":"To'g'ri javob: B) Uch bosqich"},
            {"q":"Banklarni tugatish jarayonida ustuvor maqsad nimadan iborat?","opts":["Xodimlarni himoya qilish", "Kreditorlar va omonatchilar talablarini eng to'liq qondirish", "Bank egalarining manfaatlarini himoya qilish", "Davlat manfaatlarini himoya qilish"],"ans":1,"exp":"To'g'ri javob: B) Kreditorlar va omonatchilar talablarini eng to'liq qondirish"},
            {"q":"Banklarning filiallari qachondan boshlab o'z faoliyatlarini boshlaydilar?","opts":["Hukumat ruxsatidan so'ng", "Markaziy bankda ro'yxatdan o'tgan kundan", "Litsenziya olgan kundan", "Birinchi operatsiya qilingan kundan"],"ans":1,"exp":"To'g'ri javob: B) Markaziy bankda ro'yxatdan o'tgan kundan"},
            {"q":"Bankni tugatish turlarini belgilang:","opts":["Faqat majburiy tugatish", "Ixtiyoriy va majburiy tugatish", "Uch tur mavjud", "Faqat bankrotlik"],"ans":1,"exp":"To'g'ri javob: B) Ixtiyoriy va majburiy tugatish"},
            {"q":"Tijorat bankini qayta tashkil etish shakllari qaysi javobda to'liq va to'g'ri keltirilgan?","opts":["Faqat qo'shib olish", "Faqat qo'shib yuborish va bo'lish", "Qo'shib yuborish, qo'shib olish, bo'lish va ajratib chiqarish", "Uch shakl mavjud"],"ans":2,"exp":"To'g'ri javob: B) Qo'shib yuborish, qo'shib olish, bo'lish va ajratib chiqarish"},
            {"q":"Bank ustav fondi qanday manbalar hisobidan shakllantiriladi?","opts":["Faqat xorijiy investitsiyalar hisobidan", "Faqat kredit mablag'lari hisobidan", "Faqat davlat mablag'lari hisobidan", "Aktsiyadorlar (muassislar) tomonidan qo'yilgan pul mablag'lari, qimmatli qog'ozlar va boshqa modd..."],"ans":3,"exp":"To'g'ri javob: B) Aktsiyadorlar (muassislar) tomonidan qo'yilgan pul mablag'lari, qimmatli qog'ozlar va boshqa moddiy qiymatliklar hisobidan"},
            {"q":"Qaysi davlatda valyuta kursini o'rnatishda teskari kotirovkadan foydalaniladi?","opts":["Yaponiya", "Buyuk Britaniya (1 funt sterling = X dollar shaklida)", "AQSh", "Yevropa"],"ans":1,"exp":"To'g'ri javob: C) Buyuk Britaniya (1 funt sterling = X dollar shaklida)"},
            {"q":"Milliy valyutaning xorijiy valyutaga nisbatan qadri tushishi nima?","opts":["Diversifikatsiya", "Revalvatsiya", "Devalvatsiya", "Denominatsiya"],"ans":2,"exp":"To'g'ri javob: C) Devalvatsiya"},
            {"q":"Xorijiy valyutaning milliy valyutaga nisbatan qadri ko'tarilishi nima?","opts":["Milliy valyuta revalvatsiyasi", "Xorijiy valyuta revalvatsiyasi", "Xorijiy valyuta devalvatsiyasi", "Milliy valyuta devalvatsiyasi"],"ans":1,"exp":"To'g'ri javob: D) Xorijiy valyuta revalvatsiyasi"},
            {"q":"Milliy valyutaning xorijiy valyutaga nisbatan qadri oshishi nima?","opts":["Devalvatsiya", "Revalvatsiya", "Denominatsiya", "Inflyatsiya"],"ans":1,"exp":"To'g'ri javob: C) Revalvatsiya"},
            {"q":"Xorijiy valyutaning milliy valyutaga nisbatan qadri tushishi nima?","opts":["Xorijiy valyuta devalvatsiyasi = milliy valyuta revalvatsiyasi", "Milliy valyuta devalvatsiyasi", "Inflyatsiya", "Xorijiy valyuta revalvatsiyasi"],"ans":0,"exp":"To'g'ri javob: A) Xorijiy valyuta devalvatsiyasi = milliy valyuta revalvatsiyasi"},
            {"q":"O'zbekiston bank tizimi necha pog'onali?","opts":["To'rt pog'onali", "Uch pog'onali", "Bir pog'onali", "Ikki pog'onali (Markaziy bank + tijorat banklari)"],"ans":3,"exp":"To'g'ri javob: B) Ikki pog'onali (Markaziy bank + tijorat banklari)"},
            {"q":"O'zbekiston Respublikasi Markaziy banki nima qilishga haqli emas? (2)","opts":["Tijorat banklarini nazorat qilish", "Diskont stavkasini belgilash", "Yuridik va jismoniy shaxslarga to'g'ridan-to'g'ri kredit berish (oddiy bank kabi)", "Pul emissiyasi qilish"],"ans":2,"exp":"To'g'ri javob: B) Yuridik va jismoniy shaxslarga to'g'ridan-to'g'ri kredit berish (oddiy bank kabi)"},
            {"q":"O'zbekiston Markaziy bankining yillik hisobotini taqdim etishning so'nggi muddati qachon?","opts":["Har yilning 1-fevralgacha", "Har yilning 1-martgacha", "Har yilning 1-aprelgacha", "Har yilning 1-maygacha"],"ans":2,"exp":"To'g'ri javob: C) Har yilning 1-aprelgacha"},
            {"q":"O'zbekiston Respublikasi Markaziy banki Raisining vakolat muddati necha yil?","opts":["5 yil", "3 yil", "7 yil", "4 yil"],"ans":0,"exp":"To'g'ri javob: C) 5 yil"},
            {"q":"O'zbekiston tijorat banklari qaysi faoliyat turi bilan shug'ullanishga haqli emas?","opts":["Valyuta operatsiyalari", "Sug'urta, ishlab chiqarish va savdo faoliyati", "Depozit qabul qilish", "Kredit berish"],"ans":1,"exp":"To'g'ri javob: B) Sug'urta, ishlab chiqarish va savdo faoliyati"},
            {"q":"O'zbekiston Respublikasi Markaziy banki boshqaruvi necha kishidan iborat?","opts":["9 kishi", "5 kishi", "11 kishi", "7 kishi"],"ans":0,"exp":"To'g'ri javob: C) 9 kishi"},
            {"q":"Tijorat bankning oliy boshqaruv organi qaysi?","opts":["Taftish komissiyasi", "Boshqaruv", "Aktsiyadorlar umumiy yig'ilishi", "Kuzatuv kengashi"],"ans":2,"exp":"To'g'ri javob: C) Aktsiyadorlar umumiy yig'ilishi"},
            {"q":"'Banklar va bank faoliyati to'g'risida'gi qonun qachon yangi tahrirda qabul qilingan?","opts":["2018-yil", "2021-yil", "2019-yil", "2020-yil"],"ans":3,"exp":"To'g'ri javob: C) 2020-yil"},
            {"q":"2026-yil 1-mart holatiga ko'ra O'zbekiston Respublikasi Markaziy bankining asosiy stavkasi necha foiz?","opts":["13,5 foiz", "15 foiz", "12 foiz", "14 foiz"],"ans":0,"exp":"To'g'ri javob: B) 13,5 foiz"},
            {"q":"Talab qilib olinguncha depozit hisobraqamlarining egalari uchun asosiy afzalligi nimadan iborat?","opts":["Pul mablag'larini istalgan vaqtda to'liq yoki qisman olish imkoniyati", "Muddatli depozitga nisbatan barqarorroq", "Soliqdan ozod", "Yuqori foiz stavkasi"],"ans":0,"exp":"To'g'ri javob: B) Pul mablag'larini istalgan vaqtda to'liq yoki qisman olish imkoniyati"},
            {"q":"O'zbekistonda 2025-yil 1-yanvardan boshlab tijorat banklari ustav kapitalining minimal miqdori qancha?","opts":["200 mlrd so'm", "500 mlrd so'm", "100 mlrd so'm", "1 trln so'm"],"ans":1,"exp":"To'g'ri javob: C) 500 mlrd so'm"},
            {"q":"O'zbekistonda Mikromoliya bankni tashkil qilish uchun minimal ustav kapitali qancha?","opts":["20 mlrd so'm", "10 mlrd so'm", "5 mlrd so'm", "50 mlrd so'm"],"ans":0,"exp":"To'g'ri javob: C) 20 mlrd so'm"},
            {"q":"Tijorat banklari mijozlarining xarakteriga ko'ra necha turga bo'linadi?","opts":["Uch turga", "To'rt turga", "Besh turga", "Ikki turga: jismoniy va yuridik shaxslar"],"ans":3,"exp":"To'g'ri javob: A) Ikki turga: jismoniy va yuridik shaxslar"},
            {"q":"O'zbekiston Respublikasining Markaziy banki tijorat banklari faoliyatini necha xil usulda nazorat qiladi?","opts":["To'rt usulda", "Uch usulda", "Bir usulda", "Ikki usulda: inspeksion va distansion"],"ans":3,"exp":"To'g'ri javob: A) Ikki usulda: inspeksion va distansion"},
            {"q":"Inspeksion nazorat qay tartibda o'tkaziladi?","opts":["Faqat rejalanmagan", "Bankda bevosita (joyida) tekshirish orqali – rejali va rejalanmagan", "Faqat rejali ravishda", "Faqat masofadan"],"ans":1,"exp":"To'g'ri javob: B) Bankda bevosita (joyida) tekshirish orqali – rejali va rejalanmagan"},
            {"q":"Distansion nazorat qay tartibda o'tkaziladi?","opts":["Faqat yiliga bir marta", "Bankda bevosita tekshirish orqali", "Bank tomonidan taqdim etilgan moliyaviy hisobotlar va statistik ma'lumotlarni masofadan tahlil qi...", "Faqat inqiroz davrida"],"ans":2,"exp":"To'g'ri javob: B) Bank tomonidan taqdim etilgan moliyaviy hisobotlar va statistik ma'lumotlarni masofadan tahlil qilish orqali"},
            {"q":"XVF tomonidan xalqaro rezerv valyuta maqomi nechta valyutaga berilgan?","opts":["3 ta", "6 ta", "5 ta (dollar, evro, yuan, funt, yen)", "4 ta"],"ans":2,"exp":"To'g'ri javob: C) 5 ta (dollar, evro, yuan, funt, yen)"},
            {"q":"XVF Xitoy yuanini xalqaro rezerv valyuta sifatida qaysi yil tan oldi?","opts":["2010-yil", "2016-yil", "2013-yil", "2019-yil"],"ans":1,"exp":"To'g'ri javob: C) 2016-yil"},
            {"q":"Banklararo vakillik munosabatlarining necha turi mavjud?","opts":["Besh tur", "Ikki tur: Nostro va Vostro", "To'rt tur", "Uch tur"],"ans":1,"exp":"To'g'ri javob: A) Ikki tur: Nostro va Vostro"},
            {"q":"Dastlabki jirobanklar qaysi davlatda tashkil etilgan?","opts":["Italiyada", "Fransiyada", "Gollandiyada (Amsterdam, 1609)", "Angliyada"],"ans":2,"exp":"To'g'ri javob: C) Gollandiyada (Amsterdam, 1609)"},
            {"q":"2017-yilning 1-oktyabridan mikrokredit tashkilotlari uchun ustav kapitalining eng kam miqdori qancha?","opts":["500 mln so'm", "2 mlrd so'm", "5 mlrd so'm", "1 mlrd so'm"],"ans":1,"exp":"To'g'ri javob: C) 2 mlrd so'm"},
            {"q":"2017-yilning 1-oktyabridan lombardlar uchun ustav kapitalining eng kam miqdori qancha?","opts":["1 mlrd so'm", "500 mln so'm", "200 mln so'm", "2 mlrd so'm"],"ans":1,"exp":"To'g'ri javob: B) 500 mln so'm"},
            {"q":"Ipotekani qayta moliyalashtirish tashkiloti uchun ustav kapitalining eng kam miqdori qancha?","opts":["10 mlrd so'm", "20 mlrd so'm", "50 mlrd so'm", "100 mlrd so'm"],"ans":2,"exp":"To'g'ri javob: C) 50 mlrd so'm"},
            {"q":"Lombardlar jismoniy shaxslarni ko'pi bilan qancha muddatga kreditlashi mumkin?","opts":["3 oy", "6 oy", "1 yil", "2 yil"],"ans":2,"exp":"To'g'ri javob: C) 1 yil"},
            {"q":"Lombard tashkilotlari tijorat banklaridan qancha summagacha kredit olishi mumkin?","opts":["Ustav kapitalining 5 baravaridan oshmaydigan miqdorda", "Cheklovlar yo'q", "Ustav kapitalining 3 baravaridan oshmaydigan miqdorda", "Ustav kapitalining 2 baravaridan oshmaydigan miqdorda"],"ans":3,"exp":"To'g'ri javob: A) Ustav kapitalining 2 baravaridan oshmaydigan miqdorda"},
            {"q":"Qarz oluvchiga tadbirkorlik faoliyatini amalga oshirish uchun 300 milliondan oshmaydigan summada beriladigan kredit qaysi?","opts":["Mikrokreditning tadbirkorlik turi", "Lombard krediti", "Iste'mol krediti", "Ipoteka krediti"],"ans":0,"exp":"To'g'ri javob: B) Mikrokreditning tadbirkorlik turi"},
            {"q":"Mikrokredit tashkilotlari tomonidan jismoniy shaxsga 100 milliondan oshmaydigan summada beriladigan qarz qaysi?","opts":["Bank iste'mol krediti", "Iste'mol mikrokrediti", "Mikroqarz (mikrokredit)", "Lombard krediti"],"ans":2,"exp":"To'g'ri javob: B) Mikroqarz (mikrokredit)"},
            {"q":"Qaysi kreditlarga maqsadlilik tamoyili talab etilmaydi?","opts":["Ipoteka kreditiga", "Investitsiya kreditiga", "Overdraft va kredit liniyas kabi revolving kreditlarga", "Iste'mol kreditiga"],"ans":2,"exp":"To'g'ri javob: B) Overdraft va kredit liniyas kabi revolving kreditlarga"},
            {"q":"Banklar faoliyatidagi risklarning kuchayishi natijasida aktivlar sifati pasayishi va moliyaviy holatning yomonlashishi bu:","opts":["Bank distress (bank qiyinchiligi/inqirozi)", "Bank diversifikatsiyasi", "Bank ekspansiyasi", "Bank modernizatsiyasi"],"ans":0,"exp":"To'g'ri javob: B) Bank distress (bank qiyinchiligi/inqirozi)"},
            {"q":"O'zbekiston Respublikasida Bank kengashi a'zolari kamida nechta bo'lishi kerak?","opts":["7 ta", "9 ta", "3 ta", "5 ta"],"ans":3,"exp":"To'g'ri javob: B) 5 ta"},
            {"q":"Tijorat banklari qaysi faoliyat turlari bilan shug'ullanish taqiqlangan?","opts":["Sug'urta, ishlab chiqarish, savdo va vositachi faoliyat", "Lizing operatsiyalari", "Investitsion faoliyat", "Valyuta operatsiyalari"],"ans":0,"exp":"To'g'ri javob: B) Sug'urta, ishlab chiqarish, savdo va vositachi faoliyat"},
            {"q":"'Banklardagi omonatlarni himoya qilish to'g'risida' qonun qachon qabul qilingan?","opts":["2015-yil", "2008-yil", "2000-yil", "2002-yil"],"ans":1,"exp":"To'g'ri javob: C) 2008-yil"},
            {"q":"Fuqarolarning banklardagi omonatlarini kafolatlash agentligining vazifasi nima?","opts":["Valyuta kursini belgilash", "Bank litsenziyalarini berish", "Kredit berish", "Bank tugatilgan taqdirda omonatchilarga kompensatsiya to'lash"],"ans":3,"exp":"To'g'ri javob: C) Bank tugatilgan taqdirda omonatchilarga kompensatsiya to'lash"},
            {"q":"Kredit siyosatini qayta ko'rib chiqish muddati qancha?","opts":["Har kvartalda", "Yiliga kamida bir marta", "Har uch yilda", "Har oyda"],"ans":1,"exp":"To'g'ri javob: C) Yiliga kamida bir marta"},
            {"q":"Foiz marjasi nima?","opts":["Kredit foiz stavkasi bilan depozit foiz stavkasi o'rtasidagi farq", "Bankning operatsion xarajatlari", "Majburiy rezervlar normasi", "Bankning umumiy daromadi"],"ans":0,"exp":"To'g'ri javob: B) Kredit foiz stavkasi bilan depozit foiz stavkasi o'rtasidagi farq"},
            {"q":"Bank aktiviga tegishli bo'lgan ko'rsatkichni aniqlang:","opts":["Bank emitgan obligatsiyalar", "Ustav kapitali", "Omonatlar", "Kreditlar (berilgan ssudalar)"],"ans":3,"exp":"To'g'ri javob: B) Kreditlar (berilgan ssudalar)"},
            {"q":"Bank passiviga tegishli bo'lmagan ko'rsatkichni aniqlang:","opts":["Jalb qilingan depozitlar", "Qarz mablag'lari", "Ustav kapitali", "Berilgan kreditlar"],"ans":3,"exp":"To'g'ri javob: B) Berilgan kreditlar"},
            {"q":"Markaziy bank tomonidan banklarga ta'minotsiz kreditlar qancha muddatga beriladi?","opts":["1 kungacha", "30 kungacha", "7 kungacha", "90 kungacha"],"ans":2,"exp":"To'g'ri javob: B) 7 kungacha"},
            {"q":"Nullifikatsiya nima?","opts":["Pul miqdorini kamaytirish", "Pul birligini qayta nomlash", "Davlat eski pulni butunlay bekor qilib, to'lov kuchini yo'qotishini e'lon qilishi", "Pulning nol qiymatiga tushishi"],"ans":2,"exp":"To'g'ri javob: B) Davlat eski pulni butunlay bekor qilib, to'lov kuchini yo'qotishini e'lon qilishi"},
            {"q":"Ta'lim krediti nima maqsadga beriladi?","opts":["Ishlab chiqarish jihozlari uchun", "O'qish to'lovini to'lash, o'quv materiali va yashash xarajatlarini qoplash uchun", "Biznes ochish uchun", "Uy-joy sotib olish uchun"],"ans":1,"exp":"To'g'ri javob: B) O'qish to'lovini to'lash, o'quv materiali va yashash xarajatlarini qoplash uchun"},
            {"q":"Chet el kapitali ishtirokidagi bank nima?","opts":["Ustav kapitalida xorijiy investorlar ulushi mavjud bo'lgan bank", "Faqat xorijiy valyutada ishlaydigan bank", "Xalqaro moliya instituti", "To'liq xorijiy bank"],"ans":0,"exp":"To'g'ri javob: B) Ustav kapitalida xorijiy investorlar ulushi mavjud bo'lgan bank"},
            {"q":"Markaziy bankning ochiq bozordagi operatsiyalari limitini kim belgilaydi?","opts":["Hukumat", "Markaziy bankning o'zi (boshqaruv)", "Oliy Majlis", "Moliya vazirligi"],"ans":1,"exp":"To'g'ri javob: C) Markaziy bankning o'zi (boshqaruv)"},
            {"q":"Dunyoda birinchi bo'lib banknotani emissiya qilgan Markaziy bank qaysi?","opts":["Banque de France", "Bank of England (Angliya)", "Riksbank (Shvetsiya, 1661)", "Federal Rezerv (AQSh)"],"ans":2,"exp":"To'g'ri javob: B) Riksbank (Shvetsiya, 1661)"},
            {"q":"Dunyoda mustaqilligi eng yuqori Markaziy banklar berilgan qatorda qaysilar?","opts":["AQSh FED va Xitoy Xalq banki", "O'zbekiston va Rossiya Markaziy banklari", "Evropa Markaziy banki va Germaniya Bundesbank", "Yaponiya va Kanada Markaziy banklari"],"ans":2,"exp":"To'g'ri javob: B) Evropa Markaziy banki va Germaniya Bundesbank"},
            {"q":"Angliyaning Markaziy banki (Bank of England) nechanchi yilda tashkil etilgan?","opts":["1594-yil", "1694-yil", "1794-yil", "1894-yil"],"ans":1,"exp":"To'g'ri javob: B) 1694-yil"},
            {"q":"GMT indeksi bo'yicha Markaziy bankning siyosiy mustaqilligi nimani bildiradi?","opts":["Bank xodimlarining soni", "Bank kapitalining miqdori", "Markaziy bankning hukumat va siyosiy kuchlardan qonuniy va amaliy mustaqillik darajasi", "Bankning daromadliligi"],"ans":2,"exp":"To'g'ri javob: B) Markaziy bankning hukumat va siyosiy kuchlardan qonuniy va amaliy mustaqillik darajasi"},
            {"q":"GMT indeksi bo'yicha Markaziy bankning iqtisodiy mustaqilligi nimani bildiradi?","opts":["Markaziy bankning pul-kredit siyosatini o'zi belgilash va amalga oshirish qobiliyati", "Bankning foyda darajasi", "Bank aktivlari miqdori", "Bankning xalqaro aloqalari"],"ans":0,"exp":"To'g'ri javob: B) Markaziy bankning pul-kredit siyosatini o'zi belgilash va amalga oshirish qobiliyati"},
            {"q":"Tijorat bankining operatsiyasi deganda nima tushuniladi?","opts":["Bank tomonidan qonun doirasida amalga oshiriladigan moliyaviy bitim yoki muomala", "Faqat valyuta almashtirish", "Faqat kredit berish", "Faqat depozit qabul qilish"],"ans":0,"exp":"To'g'ri javob: B) Bank tomonidan qonun doirasida amalga oshiriladigan moliyaviy bitim yoki muomala"},
            {"q":"Tijorat banklarining aktiv operatsiyasi bu:","opts":["Depozitlarni qabul qilish", "Ustav kapitalini shakllantirish", "Mablag'larni joylashtirish operatsiyalari (kredit berish, qimmatli qog'ozlar sotib olish)", "Obligatsiyalar chiqarish"],"ans":2,"exp":"To'g'ri javob: C) Mablag'larni joylashtirish operatsiyalari (kredit berish, qimmatli qog'ozlar sotib olish)"},
            {"q":"Tijorat banklarining passiv operatsiyasi bu:","opts":["Qimmatli qog'ozlar sotib olish", "Resurslarni jalb qilish va kapitalini shakllantirish operatsiyalari (depozit, qarz olish)", "Valyuta sotish", "Kredit berish"],"ans":1,"exp":"To'g'ri javob: B) Resurslarni jalb qilish va kapitalini shakllantirish operatsiyalari (depozit, qarz olish)"},
            {"q":"Bankning kapitalini shakllantirish va resurslar jalb qilish qaysi operatsiyaga kiradi?","opts":["Aktiv operatsiyalar", "Vositachilik operatsiyalari", "Passiv operatsiyalar", "Noan'anaviy operatsiyalar"],"ans":2,"exp":"To'g'ri javob: B) Passiv operatsiyalar"},
            {"q":"Tijorat banklarida eng yuqori likvidli aktivlar qaysilar?","opts":["Berilgan kreditlar", "Qimmatli qog'ozlar", "Kassa va Markaziy bankdagi hisobraqamlar (naqd pullar va majburiy zahiralar)", "Binolar va uskunalar"],"ans":2,"exp":"To'g'ri javob: B) Kassa va Markaziy bankdagi hisobraqamlar (naqd pullar va majburiy zahiralar)"},
            {"q":"Tijorat banklarining depozit operatsiyalari bu:","opts":["Aholidan va yuridik shaxslardan pul mablag'larini omonat sifatida jalb qilish operatsiyalari", "Bankning investitsiya faoliyati", "Bankning kredit berish faoliyati", "Valyuta operatsiyalari"],"ans":0,"exp":"To'g'ri javob: B) Aholidan va yuridik shaxslardan pul mablag'larini omonat sifatida jalb qilish operatsiyalari"},
            {"q":"Talab qilib olinadigan depozitlar turli mamlakatlarda qanday nomlanadi?","opts":["Turlicha: AQShda – demand deposit, Angliyada – current account, Germaniyada – Girokonto va b.", "Barcha mamlakatlarda bir xil nomlanadi", "Faqat 'talab depoziti' deyiladi", "Faqat 'joriy hisob' deyiladi"],"ans":0,"exp":"To'g'ri javob: B) Turlicha: AQShda – demand deposit, Angliyada – current account, Germaniyada – Girokonto va b."},
            {"q":"Bank tizimi nima?","opts":["Davlat moliya muassasalari tizimi", "Markaziy bank va tijorat banklari hamda boshqa kredit muassasalarining yig'indisi", "Faqat tijorat banklar majmui", "Faqat Markaziy bankdan iborat tizim"],"ans":1,"exp":"To'g'ri javob: B) Markaziy bank va tijorat banklari hamda boshqa kredit muassasalarining yig'indisi"},
            {"q":"Kredit tizimi nima?","opts":["Kredit munosabatlarini amalga oshiruvchi barcha kredit muassasalari va ularning faoliyat shakllar...", "Faqat qisqa muddatli kreditlar", "Davlat qarz majburiyatlari", "Faqat bank kreditlari"],"ans":0,"exp":"To'g'ri javob: B) Kredit munosabatlarini amalga oshiruvchi barcha kredit muassasalari va ularning faoliyat shakllari majmui"},
            {"q":"Emitent nima?","opts":["Bank nazorat organi", "Qimmatli qog'ozlar brokeri", "Qimmatli qog'ozlar yoki pullarni chiqaruvchi davlat, bank yoki korxona", "Qimmatli qog'ozlarni sotib oluvchi shaxs"],"ans":2,"exp":"To'g'ri javob: B) Qimmatli qog'ozlar yoki pullarni chiqaruvchi davlat, bank yoki korxona"},
            {"q":"Kafillik nima?","opts":["Uchinchi shaxsning (kafil) qarz oluvchi majburiyatlarini bajarishi uchun bergan yozma kafolati", "Sug'urta", "Mulk garovi", "Bank kafolati"],"ans":0,"exp":"To'g'ri javob: B) Uchinchi shaxsning (kafil) qarz oluvchi majburiyatlarini bajarishi uchun bergan yozma kafolati"},
            {"q":"Kafolat nima?","opts":["Bank krediti turi", "Kafolat beruvchining muayyan shartlar yuzaga kelganda to'lovni amalga oshirish majburiyatini o'z ...", "Sug'urta shartnomasi", "Qarz oluvchining mulki hisobiga to'lov kafolati"],"ans":1,"exp":"To'g'ri javob: B) Kafolat beruvchining muayyan shartlar yuzaga kelganda to'lovni amalga oshirish majburiyatini o'z zimmasiga olishi"},
            {"q":"Bank siri to'g'risidagi qonun qachon qabul qilingan?","opts":["2004-yil", "2006-yil", "2000-yil", "2010-yil"],"ans":1,"exp":"To'g'ri javob: C) 2006-yil"},
            {"q":"Tijorat banklarining asosiy maqsadi qaysi?","opts":["Faqat kredit berish", "Faqat ijtimoiy xizmat ko'rsatish", "Foyda olish (rentabellik) va likvidlikni ta'minlash", "Faqat pul emissiyasi"],"ans":2,"exp":"To'g'ri javob: B) Foyda olish (rentabellik) va likvidlikni ta'minlash"},
            {"q":"Depozit qabul qilish huquqiga ega bo'lmagan kredit tashkilotiga misol:","opts":["Tijorat banki", "Mikrokredit tashkiloti", "Jamg'arma banki", "Ipoteka banki"],"ans":1,"exp":"To'g'ri javob: C) Mikrokredit tashkiloti"},
            {"q":"Pul-kredit siyosatining asosiy instrumentlari nechta?","opts":["Besh ta", "To'rt ta", "Ikki ta", "Uch ta (majburiy rezerv, ochiq bozor operatsiyalari, diskont stavkasi)"],"ans":3,"exp":"To'g'ri javob: B) Uch ta (majburiy rezerv, ochiq bozor operatsiyalari, diskont stavkasi)"},
            {"q":"O'zbekiston Respublikasida Markaziy bankning minimal ustav kapitali qancha?","opts":["200 mlrd so'm", "500 mlrd so'm", "1 trln so'm", "100 mlrd so'm"],"ans":0,"exp":"To'g'ri javob: B) 200 mlrd so'm"},
            {"q":"Markaziy bank mulkchilik shakliga ko'ra necha turga bo'linadi?","opts":["Ikki turga: davlat va xususiy", "Besh turga", "Uch turga: to'liq davlat, aralash va aksiyadorlik", "To'rt turga"],"ans":2,"exp":"To'g'ri javob: B) Uch turga: to'liq davlat, aralash va aksiyadorlik"},
            {"q":"Jahon bankini kim boshqaradi?","opts":["G7 mamlakatlari", "BMT Bosh kotibi", "XVF direktori", "Jahon banki prezidenti (an'anaga ko'ra AQSh fuqarosi)"],"ans":3,"exp":"To'g'ri javob: B) Jahon banki prezidenti (an'anaga ko'ra AQSh fuqarosi)"},
            {"q":"O'zbekiston XVFga qachon a'zo bo'ldi?","opts":["1990-yil", "1992-yil", "2000-yil", "1995-yil"],"ans":1,"exp":"To'g'ri javob: B) 1992-yil"},
            {"q":"EKYuning 'yevro' deb nomlanishi qaysi davlat tashabbusi bilan bo'lgan?","opts":["Italiya", "Germaniya", "Fransiya", "Belgiya"],"ans":3,"exp":"To'g'ri javob: C) Belgiya"},
            {"q":"Jahon tiklanish va taraqqiyot banki (Jahon banki) nechanchi yil tashkil topgan?","opts":["1960-yil", "1950-yil", "1930-yil", "1944-yil (Bretton-Vuds)"],"ans":3,"exp":"To'g'ri javob: B) 1944-yil (Bretton-Vuds)"},
            {"q":"Bank faoliyatining sub'ektlari bo'lib kimlar hisoblanadi?","opts":["Faqat jismoniy shaxslar", "Faqat banklar", "Banklar, ularning mijozlari va bank munosabatlarida ishtirok etuvchi barcha shaxslar", "Faqat yuridik shaxslar"],"ans":2,"exp":"To'g'ri javob: B) Banklar, ularning mijozlari va bank munosabatlarida ishtirok etuvchi barcha shaxslar"},
            {"q":"Bank faoliyatini boshqarishdan asosiy maqsad nima?","opts":["Likvidlik, rentabellik va xavfsizlikni muvozanatda saqlash", "Faqat mijozlarga xizmat ko'rsatish", "Faqat xavfsizlikni ta'minlash", "Maksimal foyda olish"],"ans":0,"exp":"To'g'ri javob: B) Likvidlik, rentabellik va xavfsizlikni muvozanatda saqlash"},
            {"q":"Bank uchun zarur bo'lgan zaxiralar qaysi mablag'lar hisobidan shakllantiriladi?","opts":["Foyda, ustav kapitali va jalb qilingan mablag'larning bir qismidan", "Faqat Markaziy bank kreditidan", "Faqat jalb qilingan mablag'lardan", "Faqat ustav kapitalidan"],"ans":0,"exp":"To'g'ri javob: B) Foyda, ustav kapitali va jalb qilingan mablag'larning bir qismidan"},
            {"q":"Bu kurs ikki xorijiy valyutaning o'zaro kotirovkasi natijasida hosil bo'ladi. Bu qanday kurs?","opts":["Bozor kursi", "Forvard kurs", "Rasmiy kurs", "Kross-kurs"],"ans":3,"exp":"To'g'ri javob: C) Kross-kurs"},
            {"q":"Mikrolizing miqdori qancha?","opts":["100 mln so'mgacha", "500 mln so'mgacha", "50 mln so'mgacha", "200 mln so'mgacha"],"ans":3,"exp":"To'g'ri javob: C) 200 mln so'mgacha"},
            {"q":"Kross-kurs deganda nima tushuniladi?","opts":["Milliy valyutaning dollarga nisbatan kursi", "Oltin va valyuta paritetiga asoslangan kurs", "Markaziy bank belgilaydigan rasmiy kurs", "Ikki xorijiy valyutaning uchinchi valyuta (odatda dollar) orqali hisoblangan o'zaro kursi"],"ans":3,"exp":"To'g'ri javob: B) Ikki xorijiy valyutaning uchinchi valyuta (odatda dollar) orqali hisoblangan o'zaro kursi"},
            {"q":"SWIFT nima?","opts":["AQSHning elektron to'lov tizimi", "Xalqaro valyuta fondi tizimi", "Jahon banklararo moliyaviy telekommunikatsiya jamiyati – xalqaro to'lovlar uchun xabar almashish ...", "Evropa markaziy banki axborot tizimi"],"ans":2,"exp":"To'g'ri javob: B) Jahon banklararo moliyaviy telekommunikatsiya jamiyati – xalqaro to'lovlar uchun xabar almashish tizimi"},
            {"q":"O'zbekiston tijorat banklari milliy valyutada nechta 'Nostro' hisob raqamiga ega bo'lishi mumkin?","opts":["Uchta", "Ikkita", "Bitta", "Cheklov yo'q"],"ans":2,"exp":"To'g'ri javob: A) Bitta"},
            {"q":"Pul mablag'lari korxonaning qanday aktivi hisoblanadi?","opts":["Aylanma aktiv (eng likvid)", "Uzoq muddatli aktiv", "Nomoddiy aktiv", "Asosiy vosita"],"ans":0,"exp":"To'g'ri javob: B) Aylanma aktiv (eng likvid)"},
            {"q":"Bank tomonidan mijozning asosiy talab qilib olinguncha depozit hisobraqami asosida overdraft berilsa, bu qaysi kredit shakli?","opts":["Standart kredit", "Kredit liniyasi", "Overdraft krediti", "Kontokorrent krediti"],"ans":2,"exp":"To'g'ri javob: B) Overdraft krediti"},
            {"q":"O'zbekiston to'lov amaliyotida eng yuqori salmoqni egallayotgan to'lov shakli qaysi?","opts":["Naqd pul", "Inkasso", "To'lov topshiriqnomasi", "Akkreditiv"],"ans":2,"exp":"To'g'ri javob: C) To'lov topshiriqnomasi"},
            {"q":"Sotib olingan asosiy vositalar balansda qaysi qiymat bo'yicha aks ettiriladi?","opts":["Likvid qiymat bo'yicha", "Qoldiq qiymat bo'yicha (dastlab)", "Bozor qiymati bo'yicha", "Boshlang'ich (tarixiy) qiymat bo'yicha, amortizatsiya chegirilgan holda"],"ans":3,"exp":"To'g'ri javob: B) Boshlang'ich (tarixiy) qiymat bo'yicha, amortizatsiya chegirilgan holda"},
            {"q":"Bank ro'yxatga olingunga qadar vaqtinchalik jamg'arish hisobraqami qayerda ochiladi?","opts":["Davlat g'aznachiligida", "Moliya vazirligida", "Markaziy bankda", "Boshqa tijorat bankida"],"ans":3,"exp":"To'g'ri javob: C) Boshqa tijorat bankida"},
            {"q":"Valyuta zaxiralarini diversifikatsiyalash nima? (takrorlash)","opts":["Valyuta zaxiralarini turli valyutalar va aktiv turlari o'rtasida taqsimlash – risk kamaytirish uchun", "Barcha zaxirani dollarda saqlash", "Zaxiralarni kamaytirish", "Faqat oltin zaxirasini ko'paytirish"],"ans":0,"exp":"To'g'ri javob: B) Valyuta zaxiralarini turli valyutalar va aktiv turlari o'rtasida taqsimlash – risk kamaytirish uchun"},
            {"q":"Markaziy bank faoliyatining asosiy maqsadi nima?","opts":["Narxlar barqarorligi va milliy valyutaning barqarorligini ta'minlash", "Tijorat banklarga raqobat qilish", "Davlat byudjetini to'ldirish", "Foyda olish"],"ans":0,"exp":"To'g'ri javob: B) Narxlar barqarorligi va milliy valyutaning barqarorligini ta'minlash"},
            {"q":"Markaziy bank faoliyatining asosiy maqsadi noto'g'ri berilgan qator qaysi?","opts":["Milliy valyuta barqarorligi", "Maksimal foyda olish", "To'lov tizimining ishonchli ishlashi", "Narxlar barqarorligi"],"ans":1,"exp":"To'g'ri javob: C) Maksimal foyda olish"},
            {"q":"Quyidagilardan qaysi biri banklarni tugatishga asos bo'ladi?","opts":["Bank rahbarligini almashtirish", "Litsenziyaning bekor qilinishi, to'lovga layoqatsizlik yoki aktsiyadorlarning qaroriga ko'ra tuga...", "Filial ochish", "Foyda kamayishi"],"ans":1,"exp":"To'g'ri javob: B) Litsenziyaning bekor qilinishi, to'lovga layoqatsizlik yoki aktsiyadorlarning qaroriga ko'ra tugatish"},
            {"q":"Foiz marjasi nima? (takrorlash)","opts":["Majburiy rezerv normasi", "Bankning umumiy daromadi", "Kredit foiz stavkasi bilan depozit foiz stavkasi o'rtasidagi farq (bank foydasining asosiy manbai)", "Operatsion xarajatlar"],"ans":2,"exp":"To'g'ri javob: B) Kredit foiz stavkasi bilan depozit foiz stavkasi o'rtasidagi farq (bank foydasining asosiy manbai)"},
            {"q":"Markaziy bankning valyuta siyosatini qo'llashdan asosiy maqsad nima?","opts":["Eksportni kamaytirish", "Foyda olish", "Valyuta kursini barqarorlashtirish va tashqi to'lov balansini tartibga solish", "Import ulushini oshirish"],"ans":2,"exp":"To'g'ri javob: B) Valyuta kursini barqarorlashtirish va tashqi to'lov balansini tartibga solish"},
            {"q":"Markaziy bank tijorat banklarini necha usulda kreditlaydi?","opts":["5 usulda", "4 usulda", "3 usulda", "6 usulda"],"ans":2,"exp":"To'g'ri javob: A) 3 usulda"},
            {"q":"Tijorat banklari qachondan boshlab yuridik shaxs maqomiga ega bo'ladi?","opts":["Litsenziya olgan kundan", "Birinchi operatsiya qilingan kundan", "Faoliyat boshlagandan", "Davlat ro'yxatidan o'tgan kundan"],"ans":3,"exp":"To'g'ri javob: B) Davlat ro'yxatidan o'tgan kundan"},
            {"q":"Bankning nomoliyaviy aktivlari to'g'ri ko'rsatilgan javob qaysi?","opts":["Valyuta zahiralari", "Binolar, uskunalar, kompyuterlar va boshqa moddiy aktivlar", "Kreditlar va depozitlar", "Qimmatli qog'ozlar"],"ans":1,"exp":"To'g'ri javob: B) Binolar, uskunalar, kompyuterlar va boshqa moddiy aktivlar"},
            {"q":"Tijorat banklariga bank operatsiyalarini o'tkazish bo'yicha litsenziyani kim beradi?","opts":["Hukumat", "Banklar assotsiatsiyasi", "Markaziy bank", "Moliya vazirligi"],"ans":2,"exp":"To'g'ri javob: C) Markaziy bank"},
            {"q":"O'zbekiston Respublikasi banklar Assotsiatsiyasi (uyushmasi) qachon tashkil etilgan?","opts":["1994-yil", "1991-yil", "2000-yil", "1997-yil"],"ans":0,"exp":"To'g'ri javob: B) 1994-yil"},
            {"q":"Qanday qimmatli qog'ozlar bo'yicha daromad foydaga bog'liq?","opts":["Cheklar", "Obligatsiyalar", "Aksiyalar (dividend foydaga bog'liq)", "Veksellar"],"ans":2,"exp":"To'g'ri javob: C) Aksiyalar (dividend foydaga bog'liq)"},
            {"q":"Standart kredit toifasi uchun necha foiz zaxira yaratiladi?","opts":["5%", "1%", "2%", "0%"],"ans":3,"exp":"To'g'ri javob: A) 0%"},
            {"q":"Tijorat banki uchun taqiqlangan faoliyat turlari bu:","opts":["Kredit berish va depozit qabul qilish", "Faktoring va forfeyting", "Valyuta va lizing operatsiyalari", "Sug'urta, ishlab chiqarish, savdo va ko'chmas mulk bilan vositachilik faoliyati"],"ans":3,"exp":"To'g'ri javob: B) Sug'urta, ishlab chiqarish, savdo va ko'chmas mulk bilan vositachilik faoliyati"},
            {"q":"Markaziy bank uchun taqiqlangan faoliyat turlari:","opts":["Tijorat banklarini kreditlash", "Valyuta interventsiyasi", "Tijorat faoliyati, ishlab chiqarish va savdo operatsiyalari", "Pul emissiyasi va diskont siyosati"],"ans":2,"exp":"To'g'ri javob: B) Tijorat faoliyati, ishlab chiqarish va savdo operatsiyalari"},
            {"q":"O'zbekiston Respublikasi Markaziy banki quyidagilardan qaysi birini amalga oshirishi mumkin emas?","opts":["Valyuta kursini tartibga solish", "Davlat qimmatli qog'ozlarini ikkilamchi bozorda sotib olish", "Majburiy rezerv normalarini belgilash", "Oddiy aholidan to'g'ridan-to'g'ri omonat qabul qilish"],"ans":3,"exp":"To'g'ri javob: B) Oddiy aholidan to'g'ridan-to'g'ri omonat qabul qilish"},
            {"q":"Markaziy bankning pul-kredit siyosatining asosiy vositalariga qaysilar kiradi?","opts":["Faqat valyuta interventsiyasi", "Faqat foiz stavkasi", "Faqat emissiya", "Majburiy rezerv normasi, ochiq bozor operatsiyalari va diskont (qayta moliyalashtirish) stavkasi"],"ans":3,"exp":"To'g'ri javob: B) Majburiy rezerv normasi, ochiq bozor operatsiyalari va diskont (qayta moliyalashtirish) stavkasi"},
            {"q":"Parij valyuta tizimida (1867) qaysi standartga asos solindi?","opts":["Qog'oz pul standart", "Oltin tanga standart", "Kumush tanga standart", "Bimetall standart"],"ans":1,"exp":"To'g'ri javob: C) Oltin tanga standart"},
            {"q":"SDR nima?","opts":["Xalqaro tijorat vekseli", "AQSh dollarining boshqa nomi", "Evropa valyuta birligi", "XVF tomonidan yaratilgan maxsus qarz olish huquqi – xalqaro zahira aktivi"],"ans":3,"exp":"To'g'ri javob: B) XVF tomonidan yaratilgan maxsus qarz olish huquqi – xalqaro zahira aktivi"},
            {"q":"'Diversifikatsiya' so'zining ma'nosi nima?","opts":["Kamaytirish", "Turlilashtirish – riskni kamaytirish maqsadida turli aktivlar, soha yoki hududlarga taqsimlash", "Kengaytirish", "Markazlashtirish"],"ans":1,"exp":"To'g'ri javob: B) Turlilashtirish – riskni kamaytirish maqsadida turli aktivlar, soha yoki hududlarga taqsimlash"},
            {"q":"'Trapezitlar' so'zining ma'nosi nima?","opts":["Qadimgi Yunonistonda pul almashtiruvchi sarroflar (trapeza – stol)", "O'rta asrlardagi lombard egalari", "Qadimgi Misrdagi moliyachilar", "Qadimgi Rim sudxo'rlari"],"ans":0,"exp":"To'g'ri javob: B) Qadimgi Yunonistonda pul almashtiruvchi sarroflar (trapeza – stol)"},
            {"q":"Bank balansida bank passivlari qaysi xususiyatiga ko'ra guruhlanadi?","opts":["Daromadliligiga ko'ra", "Qoplash manbasiga ko'ra", "Likvidliligiga ko'ra", "Muddatiga ko'ra"],"ans":3,"exp":"To'g'ri javob: A) Muddatiga ko'ra"},
            {"q":"Iste'mol krediti ob'ekti nima hisoblanadi? (takrorlash)","opts":["Ishlab chiqarish uskunalari", "Aholi tomonidan shaxsiy maqsadda sotib olinadigan tovarlar, xizmatlar va boshqa ehtiyojlar", "Korxona aylanma mablag'lari", "Qimmatli qog'ozlar"],"ans":1,"exp":"To'g'ri javob: B) Aholi tomonidan shaxsiy maqsadda sotib olinadigan tovarlar, xizmatlar va boshqa ehtiyojlar"},
            {"q":"Iste'mol krediti sub'ektlari kimlar hisoblanadi?","opts":["Faqat banklar", "Kredit beruvchi bank (yoki savdo korxonasi) va kredit oluvchi jismoniy shaxslar", "Faqat yuridik shaxslar", "Faqat jismoniy shaxslar"],"ans":1,"exp":"To'g'ri javob: B) Kredit beruvchi bank (yoki savdo korxonasi) va kredit oluvchi jismoniy shaxslar"},
            {"q":"Norezident bank nima?","opts":["Xorijiy banklar filiallari", "Qo'shma bank", "Xalqaro moliya instituti", "Mamlakatda ro'yxatdan o'tmagan, shu mamlakatning rezidenti bo'lmagan bank"],"ans":3,"exp":"To'g'ri javob: B) Mamlakatda ro'yxatdan o'tmagan, shu mamlakatning rezidenti bo'lmagan bank"},
            {"q":"Kimlar kafolat berish huquqiga ega?","opts":["Faqat davlat muassasalari", "Faqat banklar", "Banklar, sug'urta kompaniyalari va qonun ruxsat bergan boshqa moliya muassasalari", "Faqat jismoniy shaxslar"],"ans":2,"exp":"To'g'ri javob: B) Banklar, sug'urta kompaniyalari va qonun ruxsat bergan boshqa moliya muassasalari"},
            {"q":"Ipoteka banklari nima?","opts":["Ko'chmas mulk garovi (ipoteka) ostida uzoq muddatli kredit beruvchi ixtisoslashgan banklar", "Faqat jismoniy shaxslarga xizmat ko'rsatuvchi banklar", "Xalqaro hisob-kitoblar banki", "Qisqa muddatli tijorat kreditlari beruvchi banklar"],"ans":0,"exp":"To'g'ri javob: B) Ko'chmas mulk garovi (ipoteka) ostida uzoq muddatli kredit beruvchi ixtisoslashgan banklar"},
            {"q":"Markaziy bankning iqtisodiy mustaqilligi nima?","opts":["Markaziy bankning pul-kredit siyosatini maqsadlari va vositalarini o'zi belgilab, hukumat ta'siri...", "Bank kapital miqdori", "Bankning xalqaro aloqalari", "Bankning foyda darajasi"],"ans":0,"exp":"To'g'ri javob: B) Markaziy bankning pul-kredit siyosatini maqsadlari va vositalarini o'zi belgilab, hukumat ta'siridan mustaqil amalga oshira olishi"},
            {"q":"YeMBning vakolatlarini qonunchilik asosida o'zgartirish uchun qanday tartib kerak?","opts":["YeMB Kengashi qaroriga ko'ra", "Faqat yirik evrozona mamlakatlari kelishuviga ko'ra", "Yevropa Parlamenti oddiy ko'pchilik ovozi bilan", "Yevropa Ittifoqi Shartnomasiga o'zgartirish kiritish – barcha a'zo davlatlar ratifikatsiyasi kerak"],"ans":3,"exp":"To'g'ri javob: B) Yevropa Ittifoqi Shartnomasiga o'zgartirish kiritish – barcha a'zo davlatlar ratifikatsiyasi kerak"},
            {"q":"Hozirgi davrda dunyo bo'yicha siyosiy mustaqillik darajasi eng yuqori Markaziy banklar qaysilar?","opts":["AQSh FED va Hindiston Markaziy banki", "Yevropa Markaziy banki va Germaniya Bundesbank", "Rossiya va Xitoy Markaziy banklari", "O'zbekiston va Qozog'iston Markaziy banklari"],"ans":1,"exp":"To'g'ri javob: B) Yevropa Markaziy banki va Germaniya Bundesbank"},
            {"q":"Federal rezerv tizimiga AQSh okruglari uchun markaz hisoblangan shaharsini ko'rsating:","opts":["Faqat Vashington DC", "Nyu-York, Chikago, San-Fransisko va boshqa 9 ta shahar (jami 12 ta Federal Rezerv banki)", "Faqat Nyu-York", "Faqat Los-Anjeles"],"ans":1,"exp":"To'g'ri javob: B) Nyu-York, Chikago, San-Fransisko va boshqa 9 ta shahar (jami 12 ta Federal Rezerv banki)"},
            {"q":"AQShda emissiya funktsiyasi kimga yuklatilgan?","opts":["Federal Rezerv tizimiga (FED) – amalda Federal Rezerv banklariga", "Moliya vazirligiga", "G'aznachilikning zarbxonasiga", "Faqat Federal Rezerv banklariga"],"ans":0,"exp":"To'g'ri javob: B) Federal Rezerv tizimiga (FED) – amalda Federal Rezerv banklariga"},
            {"q":"Naqd Yevro valyutasi qachondan boshlab muomalaga kiritildi?","opts":["2005-yil 1-yanvar", "1999-yil 1-yanvar", "2000-yil 1-yanvar", "2002-yil 1-yanvar"],"ans":3,"exp":"To'g'ri javob: C) 2002-yil 1-yanvar"},
            {"q":"Yevropa Markaziy banki qachon tashkil qilindi?","opts":["1994-yil", "2000-yil", "1998-yil", "1996-yil"],"ans":2,"exp":"To'g'ri javob: C) 1998-yil"},
            {"q":"Yevropa Markaziy bankining bosh maqsadi nima?","opts":["Foyda olish", "Evrozonada narxlar barqarorligini ta'minlash (inflyatsiyani 2% atrofida ushlab turish)", "Yevropa Ittifoqi byudjetini moliyalashtirish", "Tijorat banklarini nazorat qilish"],"ans":1,"exp":"To'g'ri javob: B) Evrozonada narxlar barqarorligini ta'minlash (inflyatsiyani 2% atrofida ushlab turish)"},
            {"q":"Angliyada dastlabki banklar qachon va qanday ko'rinishda yuzaga kelgan?","opts":["XII asrda xalifa hukmdorlari sifatida", "XIX asrda sanoat inqilobi davrida", "XVIII asrda savdogarlar o'rtasida", "XVII asrda zargarlar (goldsmith) tomonidan qimmatbaho buyumlarni saqlash va qarz berish faoliyati..."],"ans":3,"exp":"To'g'ri javob: B) XVII asrda zargarlar (goldsmith) tomonidan qimmatbaho buyumlarni saqlash va qarz berish faoliyati sifatida"},
            {"q":"XII asrlarda Genuyada 'bancheri' deb kimlar atalgan?","opts":["Pul almashtiruvchi va ssuda beradigan sarroflar", "Cherkov xizmatchilari", "Davlat amaldorlari", "Tovarlar almashtiradigan savdogarlar"],"ans":0,"exp":"To'g'ri javob: C) Pul almashtiruvchi va ssuda beradigan sarroflar"},
            {"q":"Valyuta bloki nima?","opts":["O'z valyutalarini yetakchi valyutaga bog'lab olgan mamlakatlar guruhi", "Xalqaro clearing tizimi", "Xalqaro valyuta tashkiloti", "Valyuta savdosini taqiqlovchi shartnoma"],"ans":0,"exp":"To'g'ri javob: B) O'z valyutalarini yetakchi valyutaga bog'lab olgan mamlakatlar guruhi"},
            {"q":"To'rtinchi jahon valyuta tizimida (Yamayka, 1976) qaysi valyutaga xalqaro rezerv maqomi kuchaydi?","opts":["Yapon iyenasi", "Funt sterling", "AQSh dollari (asosiy rezerv valyuta sifatida saqlanib qoldi)", "Nemis markasi"],"ans":2,"exp":"To'g'ri javob: C) AQSh dollari (asosiy rezerv valyuta sifatida saqlanib qoldi)"},
            {"q":"Tijorat banklarining kredit paketi nima?","opts":["Faqat bitta kredit mahsuloti", "Kredit shartnomasi", "Bank tomonidan turli xil kredit mahsulotlari va xizmatlarining bir qator taklif etilishi", "Kredit tarixi hujjati"],"ans":2,"exp":"To'g'ri javob: B) Bank tomonidan turli xil kredit mahsulotlari va xizmatlarining bir qator taklif etilishi"},
            {"q":"Tijorat banklarining daromad keltirmaydigan aktivlari qaysilar?","opts":["Binolar, uskunalar va boshqa asosiy vositalar (nomoddiy va moddiy aktivlar)", "Depozitlar", "Kreditlar va qimmatli qog'ozlar", "Markaziy bankdagi hisob"],"ans":0,"exp":"To'g'ri javob: B) Binolar, uskunalar va boshqa asosiy vositalar (nomoddiy va moddiy aktivlar)"},
            {"q":"O'zbekiston Respublikasi Markaziy bankining pul-kredit siyosati asosiy hujjati qaysi?","opts":["Moliyaviy barqarorlik hisoboti", "Pul-kredit siyosatining asosiy yo'nalishlari (har yili e'lon qilinadi)", "Yillik byudjet qonuni", "Markaziy bank nizomi"],"ans":1,"exp":"To'g'ri javob: B) Pul-kredit siyosatining asosiy yo'nalishlari (har yili e'lon qilinadi)"},
            {"q":"Markaziy bank tomonidan valyuta interventsiyasi nima maqsadida o'tkaziladi?","opts":["Xorijiy valyutani zaxiraga olish uchun", "Milliy valyuta kursini barqarorlashtirish yoki maqsadli darajada ushlab turish uchun", "Foyda olish maqsadida", "Inflatsiyani oshirish uchun"],"ans":1,"exp":"To'g'ri javob: B) Milliy valyuta kursini barqarorlashtirish yoki maqsadli darajada ushlab turish uchun"},
            {"q":"Likvidlik so'zining ma'nosi nima?","opts":["Xavfsizlik", "Barqarorlik", "Aktivning tez va to'liq yo'qotishsiz pul shakliga aylanishi qobiliyati", "Daromadlilik"],"ans":2,"exp":"To'g'ri javob: B) Aktivning tez va to'liq yo'qotishsiz pul shakliga aylanishi qobiliyati"},
            {"q":"Tijorat banklarining akkumulyatsiya funktsiyasi nima?","opts":["Jamiyatdagi bo'sh pul mablag'larini bank hisobraqamlarida to'plash (jalb qilish)", "Kredit berish", "Qimmatli qog'ozlar bilan ishlash", "Valyuta operatsiyalari"],"ans":0,"exp":"To'g'ri javob: B) Jamiyatdagi bo'sh pul mablag'larini bank hisobraqamlarida to'plash (jalb qilish)"},
            {"q":"Tijorat banklarining transformatsiya funktsiyasi nima?","opts":["Valyuta kursi belgilash", "Pul emissiyasi", "Hukumat topshiriqlari", "Qisqa muddatli resurslarni uzoq muddatli kreditlarga, xavfli depozitlarni xavfsizroq aktivlarga a..."],"ans":3,"exp":"To'g'ri javob: B) Qisqa muddatli resurslarni uzoq muddatli kreditlarga, xavfli depozitlarni xavfsizroq aktivlarga aylantirish"},
            {"q":"Investitsion banklar bu:","opts":["Qimmatli qog'ozlar bozorida faoliyat yurituvchi, uzoq muddatli investitsiyalarni moliyalashtiruvc...", "Faqat xorijiy valyuta operatsiyalarini amalga oshiruvchi banklar", "Aholi omonatlarini qabul qiladigan banklar", "Qisqa muddatli kreditlar beruvchi banklar"],"ans":0,"exp":"To'g'ri javob: B) Qimmatli qog'ozlar bozorida faoliyat yurituvchi, uzoq muddatli investitsiyalarni moliyalashtiruvchi banklar"},
            {"q":"Foizlar to'lanadigan jamg'arma depozitlari ko'rinishidagi kvazi-pullar pul agregatining qaysi turiga kiradi?","opts":["M1", "M3", "M2", "M0"],"ans":2,"exp":"To'g'ri javob: C) M2"},
            {"q":"Tijorat bankining aktiv operatsiyasiga qaysi misol to'g'ri?","opts":["Obligatsiya chiqarish", "Kredit berish, qimmatli qog'ozlar sotib olish, valuyta joylashtirish", "Omonat qabul qilish", "Ustav kapitalini shakllantirish"],"ans":1,"exp":"To'g'ri javob: B) Kredit berish, qimmatli qog'ozlar sotib olish, valuyta joylashtirish"},
            {"q":"Tijorat bankining passiv operatsiyasiga qaysi misol to'g'ri?","opts":["Kredit berish", "Depozit qabul qilish, qimmatli qog'ozlar chiqarish, banklararo kredit olish", "Valyuta sotib olish", "Qimmatli qog'ozlar sotib olish"],"ans":1,"exp":"To'g'ri javob: B) Depozit qabul qilish, qimmatli qog'ozlar chiqarish, banklararo kredit olish"},
            {"q":"Tijorat bankining qimmatli qog'ozlarga qilingan investitsiyalari qaysi operatsiyaga kiradi?","opts":["Aktiv operatsiyalar", "Noan'anaviy operatsiyalar", "Passiv operatsiyalar", "Vositachilik operatsiyalari"],"ans":0,"exp":"To'g'ri javob: B) Aktiv operatsiyalar"},
            {"q":"Bank tizimining elementlari to'g'ri va to'liq keltirilgan qator qaysi?","opts":["Faqat Markaziy bank", "Markaziy bank, tijorat banklari va boshqa kredit muassasalari (nobank kredit tashkilotlari)", "Faqat tijorat banklari", "Markaziy bank va hukumat"],"ans":1,"exp":"To'g'ri javob: B) Markaziy bank, tijorat banklari va boshqa kredit muassasalari (nobank kredit tashkilotlari)"},
            {"q":"Nobank kredit muassasasi tomonidan o'z muassislaridan qarz mablag'larni jalb qilish bo'yicha cheklov qancha?","opts":["Ustav kapitalining 5 baravari", "Cheklovlar yo'q", "Ustav kapitalining 3 baravari", "Ustav kapitalining 10 baravari"],"ans":0,"exp":"To'g'ri javob: A) Ustav kapitalining 5 baravari"},
            {"q":"Lombardlar uchun tijorat banklaridan qarz mablag'larni jalb qilish bo'yicha cheklov necha baravarga?","opts":["Ustav kapitalining 5 baravaridan oshmaydigan miqdorda", "Ustav kapitalining 10 baravaridan oshmaydigan miqdorda", "Cheklovlar yo'q", "Ustav kapitalining 2 baravaridan oshmaydigan miqdorda"],"ans":3,"exp":"To'g'ri javob: A) Ustav kapitalining 2 baravaridan oshmaydigan miqdorda"},
            {"q":"Lombard tashkiloti qaysi sub'ektlarga kreditlar ajratadi?","opts":["Jismoniy shaxslarga garov (qimmatbaho buyumlar, zargarlik bezaklari) asosida", "Faqat tadbirkorlarga", "Faqat davlat korxonalariga", "Faqat yuridik shaxslarga"],"ans":0,"exp":"To'g'ri javob: B) Jismoniy shaxslarga garov (qimmatbaho buyumlar, zargarlik bezaklari) asosida"},
            {"q":"XVF ekspertlarining tavsiyasiga ko'ra valyuta xalqaro rezerv bo'lishi uchun asosiy mezon qaysi?","opts":["Valyutaning keng foydalanilishi, erkin almashtiriluvchanlik va barqarorlik", "Valyuta emissiya qilinayotgan mamlakatning iqtisodiy quvvati", "Faqat eksport ulushi", "Faqat oltin bilan ta'minlanganligi"],"ans":0,"exp":"To'g'ri javob: B) Valyutaning keng foydalanilishi, erkin almashtiriluvchanlik va barqarorlik"},
            {"q":"'Valyutani tartibga solish to'g'risida'gi O'zbekiston Respublikasi qonuni qachon qabul qilingan?","opts":["1993-yil", "2010-yil", "2003-yil", "1996-yil"],"ans":2,"exp":"To'g'ri javob: C) 2003-yil"},
            {"q":"Oltinni demonetizatsiya qilish bu:","opts":["Oltin zahiralarini saqlash", "Oltin bilan savdo qilish", "Oltinning pul funktsiyasini yo'qotishi – umumiy ekvivalent va rasmiy zahira vositasi sifatidagi r...", "Oltinni ko'paytirish"],"ans":2,"exp":"To'g'ri javob: B) Oltinning pul funktsiyasini yo'qotishi – umumiy ekvivalent va rasmiy zahira vositasi sifatidagi rolidан chiqishi"},
            {"q":"Xalqaro valyuta munosabatlarini yuzaga kelish asoslari qaysi omillarga bog'liq?","opts":["Faqat siyosiy omillarga", "Xalqaro mehnat taqsimoti, jahon savdosi va xalqaro kapital harakati rivojlanishiga", "Faqat texnologik omillarga", "Faqat harbiy omillarga"],"ans":1,"exp":"To'g'ri javob: B) Xalqaro mehnat taqsimoti, jahon savdosi va xalqaro kapital harakati rivojlanishiga"},
            {"q":"Mijozlar banklarda qaysi turdagi hisobvaraqlarni ochadilar?","opts":["Joriy (talab qilib olish), jamg'arma va muddatli depozit hisobraqamlari", "Faqat joriy hisob", "Faqat kredit hisob", "Faqat muddatli depozit"],"ans":0,"exp":"To'g'ri javob: B) Joriy (talab qilib olish), jamg'arma va muddatli depozit hisobraqamlari"},
            {"q":"Naqd chet el valyutasi, chet el valyutasidagi to'lov hujjatlari, chet el valyutasidagi qimmatli qog'ozlar – bularning umumiy nomi nima?","opts":["Rezerv valyuta", "SDR", "Xorijiy valyuta", "Deviz"],"ans":3,"exp":"To'g'ri javob: B) Deviz"},
            {"q":"Kassa xizmatini ko'rsatmaydigan tijorat banki nima deyiladi?","opts":["Kassa operatsiyalaridan chiqarilgan bank yoki online-bank", "Noan'anaviy bank", "Internet bank", "Virtual bank"],"ans":0,"exp":"To'g'ri javob: C) Kassa operatsiyalaridan chiqarilgan bank yoki online-bank"},
            {"q":"Qanday banknotalar to'lovga yaroqsiz hisoblanadi?","opts":["Yirtiq, kuygan, soxta yoki jiddiy shikastlangan banknotalar", "Eski seriyali banknotalar", "Chet elda chiqarilgan banknotalar", "5 yildan oshgan banknotalar"],"ans":0,"exp":"To'g'ri javob: B) Yirtiq, kuygan, soxta yoki jiddiy shikastlangan banknotalar"},
            {"q":"O'zbekiston Respublikasi hududida naqd pulsiz hisob-kitoblarni tartibga soluvchi asosiy hujjat qaysi?","opts":["Fuqarolik kodeksi", "Ish kodeksi", "Soliq kodeksi", "O'zbekiston Respublikasi Markaziy bankining to'lov tizimiga oid me'yoriy hujjatlari va qoidalari"],"ans":3,"exp":"To'g'ri javob: B) O'zbekiston Respublikasi Markaziy bankining to'lov tizimiga oid me'yoriy hujjatlari va qoidalari"},
        ]
    },
}
...
async def handle_reply_btn(u: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # PDF dan test — tayyor testlarni yuklab olish
    if text == TX[lang]["btn_pdf"]:
        kb_rows = []
        # Mikro testlar
        mikro_parts = sorted([(k,v) for k,v in TOPICS.items() if k.startswith('mikro_yakuniy_p')],
                              key=lambda x: int(x[0].split('_p')[-1]))
        if mikro_parts:
            kb_rows.append([InlineKeyboardButton("── 📊 Mikroiqtisodiyot ──", callback_data="pdfdl_noop")])
            for k, v in mikro_parts:
                kb_rows.append([InlineKeyboardButton(
                    f"📄 {v['uz']} ({len(v['questions'])} ta)",
                    callback_data=f"pdfdl_get_{k}")])
        # Pul va Bank testlar
        pul_parts = sorted([(k,v) for k,v in TOPICS.items() if k.startswith('pul_oraliq_p')],
                            key=lambda x: int(x[0].split('_p')[-1]))
        if pul_parts:
            kb_rows.append([InlineKeyboardButton("── 🏦 Pul va Bank ──", callback_data="pdfdl_noop")])
            for k, v in pul_parts:
                kb_rows.append([InlineKeyboardButton(
                    f"📄 {v['uz']} ({len(v['questions'])} ta)",
                    callback_data=f"pdfdl_get_{k}")])
        msg = "📥 Qaysi testni PDF shaklida yuklab olmoqchisiz?" if lang=="uz" else "📥 Какой тест скачать?"
        await ctx.bot.send_message(cid, msg,
            reply_markup=InlineKeyboardMarkup(kb_rows)); return
...
# ── PDF YUKLAB OLISH ──────────────────────────────────────
def generate_test_pdf(topic_key, topic, lang):
    """Testni PDF shaklida generatsiya qilish"""
    ...
    try:
        ...
        pass   # Allaqachon ro'yxatdan o'tgan
    ...
    title_s = ParagraphStyle('t', fontName='DVB', fontSize=13,
                             textColor=colors.HexColor('#1a237e'), spaceAfter=4)
    sub_s   = ParagraphStyle('s', fontName='DV', fontSize=9,
                             textColor=colors.grey, spaceAfter=10)
    q_s     = ParagraphStyle('q', fontName='DVB', fontSize=10,
                             spaceAfter=3, leading=14)
    opt_s   = ParagraphStyle('o', fontName='DV', fontSize=10,
                             leftIndent=10, spaceAfter=2, leading=13)
    ans_s   = ParagraphStyle('a', fontName='DVB', fontSize=10,
                             textColor=colors.HexColor('#2e7d32'),
                             leftIndent=10, spaceAfter=8, leading=13)

    cat = "Mikroiqtisodiyot" if "mikro" in topic_key else "Pul va Bank"
    story = [
        Paragraph(f"{cat} — {topic['uz']}", title_s),
        Paragraph(f"Savollar: {len(topic['questions'])} ta  |  To\'g\'ri javoblar yashil rangda", sub_s),
    ]

    OPTS = ['A', 'B', 'C', 'D']
    for i, q in enumerate(topic['questions']):
        qt = q['q'].replace('&','&amp;').replace('<','&lt;').replace('>','&gt;')
        story.append(Paragraph(f"{i+1}. {qt}", q_s))
        for j, opt in enumerate(q['opts']):
            ot = opt.replace('&','&amp;').replace('<','&lt;').replace('>','&gt;')
            if j == q['ans']:
                story.append(Paragraph(f"+ {OPTS[j]}) {ot}", ans_s))
            else:
                story.append(Paragraph(f"   {OPTS[j]}) {ot}", opt_s))
...
async def cb_pdfdl(u: Update, ctx: ContextTypes.DEFAULT_TYPE):
    q    = u.callback_query; await q.answer()
    uid  = q.from_user.id
    cid  = q.message.chat_id
    data = q.data
    ...
    if data == "pdfdl_noop":
        return   # Sarlavha tugmasi — hech narsa qilma

    if data.startswith("pdfdl_get_"):
        topic_key = data[len("pdfdl_get_"):]
        ...
        try:
            buf      = generate_test_pdf(topic_key, topic, lang)
            filename = f"{topic_key}.pdf"
            await ctx.bot.send_document(
                cid, document=buf, filename=filename,
                caption=f"📄 {topic['uz']} — {len(topic['questions'])} ta savol"
            )
            await ctx.bot.send_message(cid, "✅ Tayyor!", reply_markup=main_kb(uid))
        except Exception as e:
            log.warning(f"pdfdl xato: {e}")
            await ctx.bot.send_message(cid, "❌ Xato yuz berdi.", reply_markup=main_kb(uid))
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(cb_pdfdl,  pattern="^pdfdl"))
