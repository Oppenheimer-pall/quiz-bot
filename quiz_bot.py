...
TOPICS = {
    ...
    "pul_oraliq": {
        ...
        "questions": [
            ...
            {"q":"Hozirgi kunda nechta etakchi valyuta mavjud?","opts":["5 ta", "10 ta", "7 ta (AQSh dollari, evro, yapon iyenasi, funt sterling, shveytsariya franki, kanada dollari, avstraliya dollari)", "3 ta"],"ans":2,"exp":"To'g'ri javob: A) 7 ta (AQSh dollari, evro, yapon iyenasi, funt sterling, shveytsariya franki, kanada dollari, avstraliya dollari)"},
            ...
            {"q":"Tijorat banki qanday ta'riflanadi?","opts":["Faqat depozitlar qabul qiluvchi tashkilot", "O'z xarajatlarini daromadlari hisobidan moliyalashtiradigan va yuridik shaxs maqomiga ega kredit muassasasi", "Davlatga tegishli moliya instituti", "Faqat kreditlar beruvchi tashkilot"],"ans":1,"exp":"To'g'ri javob: A) O'z xarajatlarini daromadlari hisobidan moliyalashtiradigan va yuridik shaxs maqomiga ega kredit muassasasi"},
            ...
            {"q":"Kredit agentliklari qanday faoliyat olib boradi?","opts":["Kichik biznesga kredit beradi", "Aholidan depozit qabul qiladi", "Ipoteka qimmatli qog'ozlarini chiqarish yo'li bilan tijorat banklarining ipoteka kreditlarini qayta moliyalashtiradi", "Valyuta almashtirish operatsiyalarini amalga oshiradi"],"ans":2,"exp":"To'g'ri javob: A) Ipoteka qimmatli qog'ozlarini chiqarish yo'li bilan tijorat banklarining ipoteka kreditlarini qayta moliyalashtiradi"},
            ...
            {"q":"1982 yilda Meksika hukumati o'zini bankrot deb e'lon qilganda qanday vaziyat yuzaga keldi?","opts":["AQSh Meksikaga harbiy yordam berdi", "Meksika so'mi keskin qadrsizlandi", "AQSh banklari og'ir ahvolga tushdi, chunki AQSh banklari Meksikaga bergan kreditlari uchun Meksika hukumati kafolat bergan edi", "Meksikaga xorijiy investitsiyalar to'xtadi"],"ans":2,"exp":"To'g'ri javob: A) AQSh banklari og'ir ahvolga tushdi, chunki AQSh banklari Meksikaga bergan kreditlari uchun Meksika hukumati kafolat bergan edi"},
            ...
            {"q":"Valyuta davlatlararo harakatlanishi uchun qanday shartlar bajarilishi kerak?","opts":["Faqat katta iqtisodiyotga ega mamlakatning valyutasi bo'lishi kerak", "Faqat oltin bilan ta'minlangan bo'lishi kerak", "Faqat XVF a'zo mamlakatlarida muomalada bo'lishi kerak", "Xalqaro to'lov vositasi vazifasini bajara olishi va xalqaro valyuta bozorlarida oldi-sotdi qilinishi kerak"],"ans":3,"exp":"To'g'ri javob: A) Xalqaro to'lov vositasi vazifasini bajara olishi va xalqaro valyuta bozorlarida oldi-sotdi qilinishi kerak"},
            ...
            {"q":"Bretton-Vuds tizimining eng muhim yangiligi nima edi?","opts":["Tarixda birinchi marta davlatlararo valyuta va kredit munosabatlarini tartibga soluvchi organ – Xalqaro valyuta fondi tashkil etildi", "SDR (maxsus qarz olish huquqlari) joriy etildi", "Oltin standarti bekor qilindi", "Erkin suzish rejimi joriy etildi"],"ans":0,"exp":"To'g'ri javob: A) Tarixda birinchi marta davlatlararo valyuta va kredit munosabatlarini tartibga soluvchi organ – Xalqaro valyuta fondi tashkil etildi"},
            ...
            {"q":"Pul islohoti nima?","opts":["Faqat yangi pullar chiqarish", "Faqat eski pullarni muomaladan chiqarish", "Davlat tomonidan pul muomalasini tartibga solish va pul tizimini mustahkamlash maqsadida amalga oshiriladigan chora-tadbirlar yig'indisi", "Faqat valyuta kursini o'zgartirish"],"ans":2,"exp":"To'g'ri javob: A) Davlat tomonidan pul muomalasini tartibga solish va pul tizimini mustahkamlash maqsadida amalga oshiriladigan chora-tadbirlar yig'indisi"},
            ...
            {"q":"Kredit va moliya o'rtasidagi asosiy farq nima?","opts":["Kredit mablag'larining egasi o'zgarmaydi (kreditor mулкдор saqlanadi), moliyada mablag' egasi o'zgaradi", "Kredit faqat pulda, moliya faqat tovarda bo'ladi", "Kredit davlat tomonidan, moliya xususiy sektorda beriladi", "Kredit qaytarilmaydi, moliya qaytariladi"],"ans":0,"exp":"To'g'ri javob: A) Kredit mablag'larining egasi o'zgarmaydi (kreditor mулкдор saqlanadi), moliyada mablag' egasi o'zgaradi"},
            {"q":"Ссуда фонди нима?","opts":["Markaziy bankning aktivlari", "Jamiyatdagi qarzga beriluvchi qiymatning maqsadga yo'naltirilgan harakati bilan bog'liq ishlab chiqarish munosabatlari majmuasi", "Faqat banklarning zaxiralari", "Davlatning qarz mablag'lari"],"ans":1,"exp":"To'g'ri javob: A) Jamiyatdagi qarzga beriluvchi qiymatning maqsadga yo'naltirilgan harakati bilan bog'liq ishlab chiqarish munosabatlari majmuasi"},
            {"q":"Professor Sh.Abdullaeva ta'rifiga ko'ra kredit nima?","opts":["Shartnomasiz berilgan pul mablag'lari", "Vaqtincha bo'sh turgan pul mablag'larini ma'lum muddatga, haq to'lash sharti bilan qarzga olish va qaytarib berish yuzasidan kelib chiqqan munosabatlar", "Faqat bank tomonidan beriladigan ssuda", "Davlat tomonidan beriladigan subsidiya"],"ans":1,"exp":"To'g'ri javob: A) Vaqtincha bo'sh turgan pul mablag'larini ma'lum muddatga, haq to'lash sharti bilan qarzga olish va qaytarib berish yuzasidan kelib chiqqan munosabatlar"},
            ...
            {"q":"Kreditning makroiqtisodiy chegaralariga nima kiradi?","opts":["Faqat foiz stavkasi darajasi", "Faqat bank likvidligi", "Faqat mijozning kreditga layoqatliligi", "YaIM hajmi, kredit tizimining rivojlanishi, pul-kredit siyosati maqsadlari, bozor munosabatlari darajasi"],"ans":3,"exp":"To'g'ri javob: A) YaIM hajmi, kredit tizimining rivojlanishi, pul-kredit siyosati maqsadlari, bozor munosabatlari darajasi"},
            ...
            {"q":"Kreditning zarurligiga qanday omillar sabab bo'ladi?","opts":["Faqat ishlab chiqarish sikllarining mos kelmasligi", "Ishlab chiqarish sikllarining mos kelmasligi, jamg'arish imkoniyati mavjudligi, vaqtincha bo'sh mablag'lar paydo bo'lishi", "Faqat davlat byudjet taqchilligi", "Faqat xalqaro savdo zarurligi"],"ans":1,"exp":"To'g'ri javob: A) Ishlab chiqarish sikllarining mos kelmasligi, jamg'arish imkoniyati mavjudligi, vaqtincha bo'sh mablag'lar paydo bo'lishi"},
        ]
    },
}
